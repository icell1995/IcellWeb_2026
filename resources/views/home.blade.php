...
@section('content')
    <div class="box">
        ...
        <div class="row mb-3">
            <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-2">
                <div class="card shadow rounded-4 text-bg-lgiht">
    ...
    <!-- Modal Lomba Kategori 1 -->
    {{-- <div class="modal fade" id="lombaKategori1" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="lombaKategori1Label" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="lombaKategori1Label"></h1>
                </div>
                <div class="modal-body">
                    <h3 class="fw-bold text-center text-blue-dark mb-3">PENILAIAN PENYELESAIAN PERKARA PADA APLIKASI ICELL 2024</h3>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead class="header">
                                                <tr>
                                                    <th scope="col" rowspan="3" class="text-center" style="background-color: #fd7e14">No</th>
                                                    <th scope="col" rowspan="3" class="text-center bg-warning">Polda</th>
                                                    <th scope="col" rowspan="3" class="text-center" style="background-color: #0dcaf0">Jumlah LP <br/> (LP - Limpah)</th>
                                                    <th scope="col" colspan="8" class="text-center text-white" style="background-color:rgb(35, 3, 110)">Selra</th>
                                                    <th scope="col" rowspan="3" class="text-center bg-primary text-white">Jumlah <br/> %Bobot</th>
                                                    <th scope="col" rowspan="3" class="text-center bg-secondary text-white">Limpah POM/TNI <br/> (Mengurangi Kasus)</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #d63384">P21 (Bobot: 6)</th>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #6610f2">SP3 (Bobot: 2)</th>
                                                    <th scope="col" colspan="2" class="text-center text-white bg-secondary">Diversi (Bobot: 2)</th>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #6f42c1">SP2LID (Bobot: 1)</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" class="text-center text-white" style="background-color: #d63384">Jumlah</th>
                                                    <th scope="col" class="text-center text-white" style="background-color: #d63384">% Bobot</th>
                                                    <th scope="col" class="text-center text-white" style="background-color: #6610f2">Jumlah</th>
                                                    <th scope="col" class="text-center text-white" style="background-color: #6610f2">% Bobot</th>
                                                    <th scope="col" class="text-center text-white bg-secondary">Jumlah</th>
                                                    <th scope="col" class="text-center text-white bg-secondary">% Bobot</th>
                                                    <th scope="col" class="text-center text-white" style="background-color: #6f42c1">Jumlah</th>
                                                    <th scope="col" class="text-center text-white" style="background-color: #6f42c1">% Bobot</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                    // Move the item with polda = 35 to the end of the array
                                                    $recapLombaKategori1LeaderboardItemsPolda = collect($recapLombaLeaderboardItems);
                                                ...
                                                @foreach ($recapLombaKategori1LeaderboardItemsPolda as $leaderboardItemPolda)
                                                    ...
                                                    <tr class="{{'regional-police-table-row-bg-color-' . $leaderboardItemPolda['polda']}}">
                                                        ...
                                                        <td class="text-center">{{number_format($leaderboardItemPolda['sp3_total'], 0, ',', '.')}}</td>
                                                        <td class="text-center">{{number_format($leaderboardItemPolda['sp3_total_weight_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center">{{number_format($leaderboardItemPolda['diversi_total'], 0, ',', '.')}}</td>
                                                        <td class="text-center">{{number_format($leaderboardItemPolda['diversi_total_weight_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center">{{number_format($leaderboardItemPolda['sp2lid_total'], 0, ',', '.')}}</td>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" data-bs-target="#lombaKategori2" data-bs-toggle="modal">
                        Lanjut Kategori 2<i class="bi bi-arrow-right"></i>
                    </button>
                </div>
            </div>
        </div>
   ...
   <!-- Modal Lomba Kategori 2 -->
    <div class="modal fade" id="lombaKategori2" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="lombaKategori2Label" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="lombaKategori2Label"></h1>
                </div>
                <div class="modal-body">
                    <h3 class="fw-bold text-center text-blue-dark mb-3">PENILAIAN PENYELESAIAN PERKARA PADA APLIKASI ICELL 2024</h3>
                    <div class="marquee-container">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @php
                                                    // Move the item with polda = 35 to the end of the array
                                                    $recapLombaKategori2LeaderboardItemsPolda = collect($recapLombaLeaderboardItems);
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" data-bs-target="#lombaKategori1" data-bs-toggle="modal">
                        <i class="bi bi-arrow-left"></i> Kembali Kategori 1
                    </button>
                    <button class="btn btn-primary" data-bs-target="#lombaKategori3" data-bs-toggle="modal">
                        Lanjut Kategori 3<i class="bi bi-arrow-right"></i>
                    </button>
                </div>
            </div>
        </div>
    ...
    <!-- Modal Lomba Kategori 3 -->
    <div class="modal fade" id="lombaKategori3" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="lombaKategori3Label" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="lombaKategori3Label"></h1>
                </div>
                <div class="modal-body">
                    <h3 class="fw-bold text-center text-blue-dark mb-3">PENILAIAN PENYELESAIAN PERKARA PADA APLIKASI ICELL 2024</h3>
                    <div class="marquee-container">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @php
                                                    // Move the item with polda = 35 to the end of the array
                                                    $recapLombaKategori3LeaderboardItemsPolda = collect($recapLombaLeaderboardItems);
                ...
                <div class="modal-footer">
                      <button class="btn btn-danger" data-bs-target="#lombaKategori2" data-bs-toggle="modal">
                        <i class="bi bi-arrow-left"></i> Kembali Kategori 2
                    </button>
    ...
    <!-- Modal Polres 2025-->
    {{-- <div class="modal fade" id="leaderboard2025" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="leaderboard2025Label" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="leaderboard2025Label">Rekapitulasi Selra Laka 2025</h1>
                </div>
                <div class="modal-body">
                    <h3 class="fw-bold text-blue-dark mb-4">Rekapitulasi Selra Laka {{ Carbon\Carbon::parse($recap2025BeginDate)->locale('id')->translatedFormat('Y') }}</h3>
                    <h6 class="fw-bold marked-text text-blue-dark mb-4 mt-4"><i class="bi bi-pin-angle-fill"></i> Dihitung Periode LP dari {{ App\Helpers\FormatDateHelper::formatDateRange($recap2025BeginDate, $recap2025LimitDate) }}</h6>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead class="header">
                                                <tr>
                                                    <th scope="col" rowspan="2" class="text-center" style="background-color: #fd7e14">No</th>
                                                    <th scope="col" rowspan="2" class="text-center bg-warning">Polres</th>
                                                    <th scope="col" rowspan="2" class="text-center" style="background-color: #0dcaf0">Jumlah LP <br/> (LP - Limpah)</th>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #d63384">P21</th>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #6610f2">SP3</th>
                                                    <th scope="col" colspan="2" class="text-center text-white" style="background-color: #6f42c1">SP2LID</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($recap2025LeaderboardItems as $leaderboardItemPolda)
                                                        ...
                                                        @if(isset($leaderboardItem['polres']))
                                                            @if(!in_array($leaderboardItem['polres'], ['1605']))
                                                                @php
                                                                    ...
                                                                    $sp3Total = $sp3Total + ($leaderboardItem['sp3'] ?? 0);
                                                                    $sp2lidTotal = $sp2lidTotal + ($leaderboardItem['sp2lid'] ?? 0);
                                                                    $diversiTotal = $diversiTotal + ($leaderboardItem['diversi'] ?? 0);
                                                                    $totalTotal = $totalTotal + ($leaderboardItem['total'] ?? 0);
                                                                    $onProgressTotal = $onProgressTotal + ($leaderboardItem['on_progress'] ?? 0);
                                                                    $inTheProcessTotal = $inTheProcessTotal + ($leaderboardItem['in_the_process'] ?? 0);
                                                                    $hitAndRunTotal = $hitAndRunTotal + ($leaderboardItem['hit_and_run'] ?? 0);
                                                                    $pomTniTotal = $pomTniTotal + ($leaderboardItem['pom_tni'] ?? 0);
                                                                    $newEntryCrimeClearanceTotal = $newEntryCrimeClearanceTotal + ($leaderboardItem['new_entry_crime_clearance'] ?? 0);
                                                                    $cellColor = 'regional-police-table-row-bg-color-' . $leaderboardItem['polda'];
                                                                @endphp
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center bg-success text-white">{{$leaderboardItemPolda['accident_total']}}</td>
                                                        <td class="text-center bg-success text-white">{{$leaderboardItemPolda['p21_total']}}</td>
                                                        <td class="text-center bg-success text-white">{{ number_format($leaderboardItemPolda['p21_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-success text-white">{{$leaderboardItemPolda['sp3_total']}}</td>
                                                        <td class="text-center bg-success text-white">{{ number_format($leaderboardItemPolda['sp3_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-success text-white">{{$leaderboardItemPolda['sp2lid_total']}}</td>
                                                        <td class="text-center bg-success text-white">{{ number_format($leaderboardItemPolda['sp2lid_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-success text-white">{{$leaderboardItemPolda['diversi_total']}}</td>
                                                        <td class="text-center bg-success text-white">{{ number_format($leaderboardItemPolda['diversi_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-primary text-white">{{$leaderboardItemPolda['total_total']}}</td>
                                                        <td class="text-center bg-primary text-white">{{ number_format($leaderboardItemPolda['total_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-danger marked-column text-white">{{$leaderboardItemPolda['in_the_process_total']}}</td>
                                                        <td class="text-center bg-danger marked-column text-white">{{$leaderboardItemPolda['hit_and_run_total']}}</td>
                                                        <td class="text-center bg-danger marked-column text-white">{{$leaderboardItemPolda['on_progress_total']}}</td>
                                                        <td class="text-center bg-danger marked-column text-white">{{ number_format($leaderboardItemPolda['on_progress_total_percentage'], 2) . '%'}}</td>
                                                        <td class="text-center bg-secondary text-white">{{$leaderboardItemPolda['pom_tni_total']}}</td>
                                                    </tr>
                                                @endforeach
                                                @php
                                                    $p21TotalPercentage = ($accidentTotal != 0) ? ($p21Total / $accidentTotal) * 100 : 0;
    ...
    <!-- Modal Selra 2025 Compare Before And After Selra-->
    {{-- <div class="modal fade" id="leaderboard2025Compare" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="leaderboard2025CompareLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="leaderboard2025CompareLabel">Perkembangan Selra Laka 2025</h1>
                </div>
                <div class="modal-body">
                                        ...
                                        <table class="table table-bordered">
                                            <thead class="header">
                                                <tr>
                                                    ...
                                                    <th scope="col" rowspan="2" class="text-center bg-warning">Polda</th>
                                                    <th scope="col" rowspan="2" class="text-center" style="background-color: #0dcaf0">Jumlah LP <br/> (LP - Limpah)</th>
                                                    <th scope="col" colspan="6" class="text-center bg-primary text-white">Selra Sebelum Anev</th>
                                                    <th scope="col" colspan="6" class="text-center bg-success text-white">Selra Sesudah Anev</th>
                                                    <th scope="col" colspan="6" class="text-center bg-secondary text-white">Perkembangan</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" class="text-center bg-primary text-white">P21</th>
                                                    <th scope="col" class="text-center bg-primary text-white">SP3</th>
                                                    <th scope="col" class="text-center bg-primary text-white">Diversi</th>
                                                    ...
                                                    <th scope="col" class="text-center bg-success text-white">SP2LID</th>
                                                    <th scope="col" class="text-center bg-success text-white">Jumlah</th>
                                                    <th scope="col" class="text-center bg-success text-white">%</th>

                                                    <th scope="col" class="text-center bg-secondary text-white">P21</th>
                                                    <th scope="col" class="text-center bg-secondary text-white">SP3</th>
                                                    <th scope="col" class="text-center bg-secondary text-white">Diversi</th>
                                                    <th scope="col" class="text-center bg-secondary text-white">SP2LID</th>
                                                    <th scope="col" class="text-center bg-secondary text-white">Jumlah</th>
                                                    <th scope="col" class="text-center bg-secondary text-white">%</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                    ...
                                                    $sp2lidExceptEntryTotal = 0;
                                                    $exceptEntryCrimeClearanceTotal = 0;
                                                    $exceptEntryCrimeClearanceTotalPercentage = 0;

                                                    $beforeEvalP21Total = 0;
                                                    $beforeEvalSp3Total = 0;
                                                    $beforeEvalDiversiTotal = 0;
                                                    $beforeEvalSp2lidTotal = 0;
                                                ...
                                                @foreach ($recap2025LeaderboardItemsPolda as $leaderboardItemPolda)
                                                    @php
                                                        ...
                                                        $beforeEvalP21Total = $beforeEvalP21Total + ($leaderboardItemPolda['before_eval_p21_total'] ?? 0);
                                                        $beforeEvalSp3Total = $beforeEvalSp3Total + ($leaderboardItemPolda['before_eval_sp3_total'] ?? 0);
                                                        $beforeEvalDiversiTotal = $beforeEvalDiversiTotal + ($leaderboardItemPolda['before_eval_diversi_total'] ?? 0);
                                                        $beforeEvalSp2lidTotal = $beforeEvalSp2lidTotal + ($leaderboardItemPolda['before_eval_sp2lid_total'] ?? 0);
                                                        $beforeEvalCrimeClearanceTotal = $beforeEvalCrimeClearanceTotal + ($leaderboardItemPolda['before_eval_crime_clearance_total'] ?? 0);
                                                    ...
                                                    <tr class="{{'regional-police-table-row-bg-color-' . $leaderboardItemPolda['polda']}}">
                                                        <th scope="row" class="text-center">{{$loop->iteration}}</th>
                                                        <th scope="row" class="text-center">
                                                            <button type="button" class="btn btn-sm btn-primary float-start regional-police-2024-table-row-button" id="{{'polda-' . $leaderboardItemPolda['polda']}}">
                                                                <i class="bi bi-chevron-expand"></i>
                                                            </button>
                                                        ...
                                                        <td class="text-center">{{$leaderboardItemPolda['before_eval_sp2lid_total']}}</td>
                                                        <td class="text-center">{{$leaderboardItemPolda['before_eval_crime_clearance_total']}}</td>
                                                        <td class="text-center">{{ number_format($leaderboardItemPolda['before_eval_crime_clearance_total_percentage'], 2) . '%'}}</td>
                                                        ...
                                                        <td class="text-center">{{$leaderboardItemPolda['sp2lid_except_entry_total']}}</td>
                                                        <td class="text-center">{{$leaderboardItemPolda['except_entry_crime_clearance_total']}}</td>
                                                        <td class="text-center">{{ number_format($leaderboardItemPolda['except_entry_crime_clearance_total_percentage'], 2) . '%'}}</td>
                                                    ...
                                                    @foreach ($leaderboardItemPolres as $leaderboardItem)
                                                        @if(isset($leaderboardItem['polres']))
                                                            @if(!in_array($leaderboardItem['polres'], ['1605']))
                                                                ...
                                                                <tr class="{{$cellColor}} {{'resort-police-2024-table-row-polda-' . $leaderboardItem['polda']}}" style="display:none;">
                                                                    <th scope="row" class="text-center">{{$loop->iteration}}</th>
                                                                    <td>
                                                                        {{$leaderboardItem['polres_name'] ?? ''}} ({{$leaderboardItem['polda_name'] ?? ''}})
                                                                    </td>
                                                                    ...
                                                                    <td class="text-center">{{$leaderboardItem['before_eval_sp2lid'] ?? '-'}}</td>
                                                                    <td class="text-center">{{$leaderboardItem['before_eval_crime_clearance'] ?? '-'}}</td>
                                                                    <td class="text-center">{{
                                                                    ...
                                                                    <td class="text-center">{{$leaderboardItem['sp2lid_except_entry'] ?? '-'}}</td>
                                                                    <td class="text-center">{{$leaderboardItem['except_entry_crime_clearance'] ?? '-'}}</td>
                                                                    <td class="text-center">{{
                                                                        (isset($leaderboardItem['except_entry_crime_clearance_percentage'])) ? number_format($leaderboardItem['except_entry_crime_clearance_percentage'], 2) . '%' : '-'
                                                                    }}</td>
                                                                </tr>
                                                            @endif
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center bg-secondary text-white">{{$sp2lidExceptEntryTotal}}</td>
                                                    <td class="text-center bg-primary text-white">{{$exceptEntryCrimeClearanceTotal}}</td>
                                                    <td class="text-center bg-primary text-white">{{ number_format($exceptEntryCrimeClearanceTotalPercentage, 2) . '%'}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <!-- Modal Polda 2024-->
    {{-- <div class="modal fade" id="leaderboardPolda" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="leaderboardPoldaLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="leaderboardPoldaLabel">Rekapitulasi Selra Laka 2024</h1>
                </div>
                <div class="modal-body">
    ...
    <!-- Modal Polres 2024-->
    {{-- <div class="modal fade" id="leaderboard" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="leaderboardLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="leaderboardLabel">Rekapitulasi Selra Laka 2024</h1>
                </div>
                <div class="modal-body">
                    <h3 class="fw-bold text-blue-dark mb-4">Rekapitulasi Selra Laka {{ Carbon\Carbon::parse($recapBeginDate)->locale('id')->translatedFormat('Y') }}</h3>
                    <h6 class="fw-bold marked-text text-blue-dark mb-4 mt-4"><i class="bi bi-pin-angle-fill"></i> Dihitung Periode LP dari {{ App\Helpers\FormatDateHelper::formatDateRange($recapBeginDate, $recapLimitDate) }}</h6>
                                                        ...
                                                        @if(isset($leaderboardItem['polres']))
                                                            @if(!in_array($leaderboardItem['polres'], ['1605']))
                                                                @php
                                                                    ...
                                                                    $hitAndRunTotal = $hitAndRunTotal + ($leaderboardItem['hit_and_run'] ?? 0);
                                                                    $pomTniTotal = $pomTniTotal + ($leaderboardItem['pom_tni'] ?? 0);
                                                                    $newEntryCrimeClearanceTotal = $newEntryCrimeClearanceTotal + ($leaderboardItem['new_entry_crime_clearance_total'] ?? 0);
                                                                    $cellColor = 'regional-police-table-row-bg-color-' . $leaderboardItem['polda'];
                                                                @endphp
    ...
    <!-- Modal Selra 2024 Compare Before And After Selra-->
    {{-- <div class="modal fade" id="leaderboardCompare" data-bs-backdrop="static" data-bs-keyboard="false"aria-hidden="true" aria-labelledby="leaderboardCompareLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="leaderboardCompareLabel">Perkembangan Selra Laka 2024</h1>
                </div>
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            {{--<div class="tab-pane fade show active" id="info-4-content" role="tabpanel" aria-labelledby="info-4-tab">
                                ...
                                <p class="fs-5">
                                    Kami ingin menginformasikan bahwa saat ini terdapat gangguan resmi terkait Tanda Tangan Elektronik (TTE) pada SPDP Online dan pendistribusian SPDP Online ke Kejaksaan. Oleh karena itu, kami mohon agar Bapak/Ibu berkoordinasi dengan kejaksaan setempat untuk pengiriman SPDP.
                                    <br/>
                                    <br/>
                                    Perkembangan lebih lanjut akan kami informasikan di kemudian hari.
                                    <br/>
                                    <br/>
                                ...
                                <a href="{{ asset('file/B_697_Pemberitahuan_Gangguan_Layanan_Pusat_Data_Nasional_20_Juni.pdf') }}" class="btn btn-primary mb-4 btn-lg" role="button" target="_blank">
    ...
    <script type="text/javascript">
            ...
            success: function(data) {
                ...
                Highcharts.chart('chartBar', {
                    ...
                    series: [{
                        ...
                        data: [{
                                name: get_date[0],
                                y: parseInt(get_count[0])
                                // y: 20
                            },
                            {
                                name: get_date[1],
                                y: parseInt(get_count[1])
                                // y: 12
                            },
                            {
                                name: get_date[2],
                                y: parseInt(get_count[2])
                                // y: 4
                            },
                            {
                                name: get_date[3],
                                y: parseInt(get_count[3])
                                // y: 15
                            },
                            {
                                name: get_date[4],
                                y: parseInt(get_count[4])
                                // y: 25
                            },
                            {
                                name: get_date[5],
                                y: parseInt(get_count[5])
                                // y: 22
                            },
                            {
                                name: get_date[6],
                                y: parseInt(get_count[6])
                                // y: 9
                            },
                            {
                                name: get_date[7],
                                y: parseInt(get_count[7])
                                // y: 16
                            },
                            {
                                name: get_date[8],
                                y: parseInt(get_count[8])
                                // y: 26
                            },
                            {
                                name: get_date[9],
                                y: parseInt(get_count[9])
                                // y: 14
                            },
                            {
                                name: get_date[10],
                                y: parseInt(get_count[10])
                                // y: 5
                            },
                            {
                                name: get_date[11],
                                y: parseInt(get_count[11])
                                // y: 2
                            },
                        ]
                    }]
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // for(x=0; x< a; x++){
                // get_date.push([data[x].date]);
                // get_percentage.push([data[x].percentage]);
                get_month.push([data[0].date_month]);
                get_year.push([data[0].date_year]);
                get_jumlah.push([data[0].jumlah_laka]);
                // }
                Highcharts.chart('chartPie', {
                    ...
                    title: {
                        // text: 'Jumlah Laka Sidik Bulan '+get_date[0]+' sampai '+get_date[11]+' sebanyak : '+get_jumlah[0]+' laka'
                        //text: 'Jumlah SELRA Bulan Januari '+get_year[0]+' sampai '+get_month[0]+' '+get_year[0]+' sebanyak : '+get_jumlah[0]+' laka',
                        text: 'Jumlah SELRA Tahun ' + get_year[0] + ' sebanyak : ' + get_jumlah[0] +
                            ' LP',
                        style: {
                            fontWeight: 'bold'
                        }
                    ...
                    subtitle: {
                        text: '( Berdasarkan Tanggal Tindak Lanjut Tahun ' + get_year[0] + ' )',
                        style: {
                            fontWeight: 'bold',
                            fontSize: '14px'
                        }
                    ...
                    series: [{
                        ...
                        data: [{
                                name: get_selra[0],
                                y: parseFloat(get_percentage[0])
                                // y: 30
                            },
                            {
                                name: get_selra[1],
                                y: parseFloat(get_percentage[1])
                                // y: 24
                            },
                            {
                                name: get_selra[2],
                                y: parseFloat(get_percentage[2])
                                // y: 11
                            },
                            {
                                name: get_selra[3],
                                y: parseFloat(get_percentage[3])
                                // y: 17
                            },
                            {
                                name: get_selra[4],
                                y: parseFloat(get_percentage[4])
                                // y: 6
                            },
                            {
                                name: get_selra[5],
                                y: parseFloat(get_percentage[5])
                                // y: 25
                            },
                            // {
                            //     name: get_selra[6],
                            //     y: parseFloat(get_percentage[6])
                            //     // y: 34
                            // },
                        ]
