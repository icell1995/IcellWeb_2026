    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content light-blue">
            ...
            <div class="modal-header border-0">
                <h4 class="m-0 fw-semibold text-blue-dark">Tambah Anggota Baru</h4>
            </div>

            <form method="POST" action="{{ route('petugas_add') }}" name="form" id="form">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <input id="first_name_add" type="text"
                                    class="form-control input-form @error('first_name') is-invalid @enderror"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <input id="nrp_add" type="text"
                                    class="form-control input-form @error('nrp_add') is-invalid @enderror"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <select id="posisi_add" name="posisi_add" class="input-form form-select">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <select id="polda_id_add"
                                    class="input-form form-select @error('polda_id_add') is-invalid @enderror"
                                    name="polda_id_add">
                                    <option value="" class="option">Pilih Polda</option>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <select id="polres_id_add"
                                    class="input-form form-select @error('polres_id_add') is-invalid @enderror"
                                    name="polres_id_add">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <select id="kepala_add" name="kepala_add" class="input-form form-select">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-3">
                            <div class="form-group">
                                <select id="pangkat_add"
                                    class="input-form form-select @error('pangkat_add') is-invalid @enderror"
                                    name="pangkat_add">
