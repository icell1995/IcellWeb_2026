...
@section('_title', 'Edit Cluster Jabatan')
...
<div class="box">
    <div class="box-header">
        <h4 class="fw-bold text-blue-dark">Edit Cluster Jabatan</h4>
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id"
                        value="{{ old('id', $positionCluster->id) }}" required
                        placeholder="ID">
                    @error('id')
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code"
                        value="{{ old('code', $positionCluster->code) }}"
                        placeholder="Code">
                    @error('code')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                        value="{{ old('name', $positionCluster->name) }}" required
                        placeholder="Name">
                    @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="sort" type="text" class="form-control @error('sort') is-invalid @enderror" name="sort"
                        value="{{ old('sort', $positionCluster->id) }}"
                        placeholder="Sort">
                    @error('sort')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="isActive"
                            ...
                            @if (old('isActive', $positionCluster->is_active) == 'true' || old('isActive', $positionCluster->is_active) == true) checked @endif>
                        <label for="isActive">
                            Aktif
                        </label>
                    </div>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="isCanSignatory"
                            ...
                            @if (old('isCanSignatory', $positionCluster->is_can_signatory) == 'true' || old('isCanSignatory', $positionCluster->is_can_signatory) == true) checked @endif>
