...
@section('_title', 'Validasi SP Sidik')
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Validasi Surat Perintah Penyidikan (SPRINSIDIK)</h5>
        ...
        <div class="box-body">
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input id="accidentNumber" type="text"
                            ...
                            name="accidentNumber" value="{{ $accident->no_lp }}" required placeholder="" readonly value="{{ $accident->no_lp }}">
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input id="documentNumber" type="text"
                            ...
                            name="documentNumber" value="{{ $suratPerintahPenyidikanDocument->document_number }}" required
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2-multiple" name="keywords[]" id="keywords" multiple="multiple"
                            ...
                            @foreach ($caseKeywords as $caseKeyword)
                                <option value="{{ $caseKeyword->id }}" @if($suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentCaseKeywords->where('keyword_id', $caseKeyword->id)->count() != 0){{'selected'}}@endif>{{ $caseKeyword->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2" name="caseClassification" id="caseClassification">
                            ...
                            @foreach ($caseClassifications as $caseClassification)
                                <option value="{{ $caseClassification->name }}" @if($suratPerintahPenyidikanDocument->case_classification == $caseClassification->name){{'selected'}}@endif>{{ $caseClassification->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control" id="startDate" name="startDate" placeholder="YYYY-MM-DD"
                            autocomplete="off" value="{{Carbon\Carbon::parse($suratPerintahPenyidikanDocument->start_date)->format('Y-m-d')}}" data-provide="datepicker">
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control" id="endDate" name="endDate" placeholder="YYYY-MM-DD"
                            autocomplete="off" value="{{Carbon\Carbon::parse($suratPerintahPenyidikanDocument->end_date)->format('Y-m-d')}}" data-provide="datepicker">
                        @error('endDate')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control" id="documentDate" name="documentDate" placeholder="YYYY-MM-DD"
                            autocomplete="off" value="{{Carbon\Carbon::parse($suratPerintahPenyidikanDocument->document_date)->format('Y-m-d')}}" data-provide="datepicker">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2" name="signatory" id="signatory">
                            ...
                            @foreach ($authorizedSignatories as $data)
                                ...
                                @if($officers->where('class', 'SIGNATORY')->where('register_number', $data->register_number)->count() != 0){{'selected'}}@endif>
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check mx-1">
                                <input class="form-check-input" type="radio" id="isPresentOfficerLeader"
                                    name="isPresentOfficerLeader" value="true" @if($currentLeaderOfficer->flag == 'INTERNAL'){{'checked'}}@endif>
                            ...
                            <div class="form-check mx-1">
                                <input class="form-check-input" type="radio" id="isPastOfficerLeader"
                                    name="isPresentOfficerLeader" value="false" @if($currentLeaderOfficer->flag == 'MOVED'){{'checked'}}@endif>
                        ...
                        <div id="presentOfficerLeader">
                            <select class="form-control select2" name="officerLeader" id="officerLeader">
                                ...
                                @foreach ($leaderOfficers as $data)
                                    ...
                                    @endphp
                                        <option value="{{$data->id}}" data-register-number="{{$data->register_number}}" 
                                        @if($officers->where('class', 'LEADER')->where('register_number', $data->register_number)->count() != 0){{'selected'}}@endif>
                                        {{$data->register_number . ' - ' . $data->full_name . ' | ' . $positionName}}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <select class="custom-select select2-input-group" id="officerLeaderMovedMemberOption"
                                            aria-describedby="officerLeaderMovedMemberOptionAddButtton">
                                            <option value="">--Pilih Ketua Tim Yang Telah Pindah--</option>
                                        </select>
                                        <button class="btn btn-primary" id="officerLeaderMovedMemberOptionAddButtton"
                                ...
                                <h5 class="fw-bold my-2">Data Ketua Ketika Menangani Kasus</h6>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="movedOfficerLeaderRegisterNumber"
                                            name="movedOfficerLeaderRegisterNumber" placeholder="Masukkan NRP" readonly value="{{$currentLeaderOfficer->register_number}}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="fw-bold" for="movedOfficerLeaderName">Nama</label>
                                        <input type="text" class="form-control" id="movedOfficerLeaderName"
                                            name="movedOfficerLeaderName" placeholder="Nama" readonly value="{{$currentLeaderOfficer->first_name . ' ' . $currentLeaderOfficer->last_name}}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="movedOfficerLeaderPhone"
                                            name="movedOfficerLeaderPhone" placeholder="Masukkan Nomor Telepon" readonly value="{{$currentLeaderOfficer->phone_number}}">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="movedOfficerLeaderRankName"
                                            name="movedOfficerLeaderRankName" placeholder="--Pangkat--" readonly value="{{$currentLeaderOfficer->rank->name ?? ''}}">
                                        <input type="hidden" class="form-control" id="movedOfficerLeaderRankId"
                                            name="movedOfficerLeaderRankId" value="{{$currentLeaderOfficer->rank->id ?? ''}}">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="movedOfficerLeaderPositionName"
                                            name="movedOfficerLeaderPositionName" placeholder="--Jabatan--" readonly value="{{$currentLeaderOfficer->position->name ?? ''}}">
                                        <input type="hidden" class="form-control" id="movedOfficerLeaderPositionId"
                                            name="movedOfficerLeaderPositionId" readonly value="{{$currentLeaderOfficer->position->id ?? ''}}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="fw-bold" for="movedOfficerLeaderPolice">Kesatuan</label>
                                        @php
                                            $currentLeaderOfficerPolice = $currentLeaderOfficer->police()->with('parent')->first();
                                            $resortPolice = null;
                                            $resortPoliceName = null;
                                            $resortPoliceId = null;

                                            $regionalPolice = null;
                                            $regionalPoliceName = null;
                                            $regionalPoliceId = null;

                                            if($currentLeaderOfficerPolice){
                                                if($currentLeaderOfficerPolice->class == 'RESOR'){
                                                    $resortPolice = $currentLeaderOfficerPolice;
                                                    $resortPoliceName = $resortPolice->full_name;
                                                    $resortPoliceId = $resortPolice->id;

                                                    $regionalPolice = $currentLeaderOfficerPolice->parent;
                                                    $regionalPoliceName = $regionalPolice->full_name;
                                                    $regionalPoliceId = $regionalPolice->id;

                                                }else if($currentLeaderOfficerPolice->class == 'DAERAH'){
                                                    $resortPolice = null;
                                                    $resortPoliceName = null;
                                                    $resortPoliceId = null;

                                                    $regionalPolice = $currentLeaderOfficerPolice;
                                                    $regionalPoliceName = $regionalPolice->full_name;
                                                    $regionalPoliceId = $regionalPolice->id;
                                                }
                                            }
                                        @endphp
                                        <input type="text" class="form-control" id="movedOfficerLeaderPolice" name="movedOfficerLeaderPolice" placeholder="--Kesatuan--" readonly value="{{$resortPoliceName . ' - ' . $regionalPoliceName}}">
                                        <input type="hidden" class="form-control" id="movedOfficerLeaderRegionalPolice" name="movedOfficerLeaderRegionalPoliceId" value="{{$regionalPoliceId}}">
                                        <input type="hidden" class="form-control" id="movedOfficerLeaderResortPolice" name="movedOfficerLeaderResortPoliceId" value="{{$resortPoliceId}}">
                                    </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            <a target="_blank"
                                                    href="@if (isset($suratPerintahPenyidikanDocument->documentCategory)) {{ route($suratPerintahPenyidikanDocument->documentCategory->base_route . '.download', ['id' => $suratPerintahPenyidikanDocument->id, 'accident_id' => $suratPerintahPenyidikanDocument->accident->id, 'document_category_id' => $suratPerintahPenyidikanDocument->documentCategory->id]) }} @endif"
                            ...
                            @if(isset($suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentAttachment->name))
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-grid gap-2">
                                                <a href="{{ asset('documents/attachments/' . $suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentAttachment->name) }}"
                        ...
                        @if(isset($suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentAttachment))
                            @if(in_array($suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentAttachment->extension, ['pdf']))
                                <!-- 16:9 aspect ratio -->
                                <br>
                                <div class="embed-responsive embed-responsive-16by1">
                                    <iframe style="top:0;left:0;width:100%;height:1024px;" class="embed-responsive-item" src="{{ asset('documents/attachments/' . $suratPerintahPenyidikanDocument->suratPerintahPenyidikanDocumentAttachment->name) }}" allowfullscreen></iframe>
                                </div>
                            @endif
                        @endif
                    </div>
            ...
            <div class="mt-4">
                <div class="text-center">
                    <button type="button" class="btn btn-danger" id="suratPerintahPenyidikanRejectValidationButton" data-bs-toggle="modal" data-bs-target="#rejectModal">
                        <i class="bi bi-box-arrow-in-down-left"></i> KEMBALIKAN
                    </button>

                    <button type="button" class="btn btn-primary" id="suratPerintahPenyidikanApproveValidationButton" data-bs-toggle="modal" data-bs-target="#approveModal">
                        <i class="bi bi-check2"></i> VALIDASI
                    </button>

                    {{-- <form action="{{route('cms.case-document-validation.module.surat-perintah-penyidikan-document.validation.approve', ['accident_id' => $suratPerintahPenyidikanDocument->accident->id, 'id' => $suratPerintahPenyidikanDocument->id, 'document_category_id' => $suratPerintahPenyidikanDocument->document_category_id])}}" method="POST" id="approveValidationForm" class="d-inline">
                        @csrf
                        @method('POST')
                        <input type="hidden" name="isApproved" id="isApproved" value="">
                        <button type="submit" class="btn btn-primary" id="suratPerintahPenyidikanApproveValidationFormSubmit">
                            <i class="bi bi-check2"></i> VALIDASi
                        </button>
                    </form> --}}
...
<div class="modal fade" id="approveModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('cms.case-document-validation.module.surat-perintah-penyidikan-document.validation.approve', ['accident_id' => $suratPerintahPenyidikanDocument->accident->id, 'id' => $suratPerintahPenyidikanDocument->id, 'document_category_id' => $suratPerintahPenyidikanDocument->document_category_id])}}" 
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isLegacy" name="isLegacy"
                                value="true" aria-label="..."
                                @if ($suratPerintahPenyidikanDocument->is_legacy == true || old('isLegacy') == 1) {{ 'checked' }} @endif>
                            <label for="isLegacy">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="suratPerintahPenyidikanApproveValidationFormSubmit">Validasi</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="rejectModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('cms.case-document-validation.module.surat-perintah-penyidikan-document.validation.reject', ['accident_id' => $suratPerintahPenyidikanDocument->accident->id, 'id' => $suratPerintahPenyidikanDocument->id, 'document_category_id' => $suratPerintahPenyidikanDocument->document_category_id])}}" 
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" id="suratPerintahPenyidikanRejectValidationFormSubmit">Kembalikan</button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <form id="addLawForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="constitutionChapterLawForm"
                                name="constitutionChapterLawForm" placeholder="Pasal" value="" disabled>
                        </div>
                    </form>
                </div>
...
@php
    ...
    $mainLaws = $laws->where('flag','MAIN')->all();
    $additionalLaws = $laws->where('flag','ADDITIONAL')->all();
@endphp
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var mainLaws = @json($mainLaws);
        var additionalLaws = @json($additionalLaws);

        //Laws
        $(function() {
            //Main Laws
            $(function() {
                for (var key in mainLaws) {
                    if (mainLaws.hasOwnProperty(key)) {
                        var mainLaw = mainLaws[key];
                        console.log(mainLaw);
                        var crimeTypeId = (mainLaw.crime_type.id != null) ? mainLaw.crime_type.id : '';
                        var crimeTypeName = (mainLaw.crime_type.name != null) ? mainLaw.crime_type.name : '';
                        var crimeClassId = (mainLaw.crime_class.id != null) ? mainLaw.crime_class.id : '';
                        var crimeClassName = (mainLaw.crime_class.name != null) ? mainLaw.crime_class.name : '';
                        var constitutionId = (mainLaw.crime_constitution.id != null) ? mainLaw.crime_constitution.id : '';
                        var constitutionName = (mainLaw.crime_constitution.name != null) ? mainLaw.crime_constitution.name : '';
                        var constitutionChapter = (mainLaw.crime_constitution.chapter != null) ? mainLaw.crime_constitution.chapter : '';

                        // Append data ke tabel
                        $('#lawTable tbody').append(
                            '<tr class="text-center">' +
                                '<td>' + crimeTypeName + '</td>' +
                                '<td>' + crimeClassName + '</td>' +
                                '<td>' + constitutionName + '</td>' +
                                '<td>' + constitutionChapter + '</td>' +
                                '<td>' +
                                    '<input type="hidden" name="lawCrimeTypeIds[]" value="' + crimeTypeId + '">' +
                                    '<input type="hidden" name="lawCrimeClassIds[]" value="' + crimeClassId + '">' +
                                    '<input type="hidden" name="lawCrimeConstitutionIds[]" value="' + constitutionId + '">' +
                                    '<input type="hidden" name="lawCrimeConstitutionChapters[]" value="' + constitutionChapter + '">' +
            ...
            //Additional Laws
            $(function() {
                for (var key in additionalLaws) {
                    if (additionalLaws.hasOwnProperty(key)) {
                        var additionalLaw = additionalLaws[key];
                        var additionalLawName = (additionalLaw.constitution.name != null) ? additionalLaw.constitution.name : '';

                        // Append data ke tabel
                        $('#additionalLawTable tbody').append(
                            '<tr class="text-center">' +
                                '<td>' + additionalLawName + '</td>' +
                                '<td>' +
                                    '<input type="hidden" name="lawAdditionalNames[]" value="' + additionalLawName + '">' +
            ...
            $(function() {
                for (var key in manualMovedOfficers) {
                    if (manualMovedOfficers.hasOwnProperty(key)) {
                        ...
                        var id = officer.register_number;
                        var registerNumber = officer.register_number;
                        var rank = officer.rank;
                        ...
                        $(document).on('click', '.editManualMovedOfficer', function() {
                            ...
                            $('#addManualMovedOfficerForm #phone').val(phone).trigger('change');
    ...
    $(document).ready(function() {
        ...
        $('#addLawButton').on('click', function() {
            ...
            $('#descriptionLawForm').val('').trigger('change');
        });
       ...
       $('#crimeTypeLawForm').on('change', function() {
        ...
        $('#saveAddLawFormButton').on('click', function() {
            ...
            var lawCrimeConstitutionChapter = $('#constitutionChapterLawForm').val();
            ...
            if (lawCrimeTypeId == '' || lawCrimeClassId == '' || lawCrimeConstitutionId == '' || lawCrimeConstitutionChapter == '') {
                ...
                $('#addLawForm #crimeTypeLawForm').parent().append('<small class="text-danger">Inputan ini wajib diisi</small>');
                $('#addLawForm #crimeClassLawForm').parent().append('<small class="text-danger">Inputan ini wajib diisi</small>');
                $('#addLawForm #crimeConstitutionLawForm').parent().append('<small class="text-danger">Inputan ini wajib diisi</small>');
                $('#addLawForm #constitutionChapterLawForm').parent().append('<small class="text-danger">Inputan ini wajib diisi</small>');
        ...
        $('#saveAdditionalLawButton').on('click', function(){
            ...
            if (lawAdditionalName == '') {
                // Hapus small text error sebelumnya
    ...
    $(document).ready(function() {
        ...
        $(function() {
            var movedOfficerLeaderRegisterNumber = $('#movedOfficerLeaderRegisterNumber').val();
                ...
                error: function(error, xhr, status) {
                    if(status == 'Not Found'){
                        return Swal.fire({
                            ...
                            text: 'Data penyidik dengan NRP ' + movedOfficerLeaderRegisterNumber + ' tidak ditemukan',
                        });
                    }
                }
            });
        ...
        $('#officerLeaderMovedOptionAddButtton').on('click', function() {
            ...
            var movedOfficerLeaderRegisterNumber = $('#officerLeaderMovedOption').find(':selected').data('register-number');
            var movedOfficerLeaderRankId = $('#officerLeaderMovedOption').find(':selected').data('rank-id');
            var movedOfficerLeaderName = $('#officerLeaderMovedOption').find(':selected').data('name');
            var movedOfficerLeaderPosition = $('#officerLeaderMovedOption').find(':selected').data('position-name');
            var movedOfficerLeaderPolresName = $('#officerLeaderMovedOption').find(':selected').data('resort-police-name');
            var movedOfficerLeaderPolresId = $('#officerLeaderMovedOption').find(':selected').data('resort-police-id');
            var movedOfficerLeaderPoldaName = $('#officerLeaderMovedOption').find(':selected').data('regional-police-name');
            var movedOfficerLeaderPoldaId = $('#officerLeaderMovedOption').find(':selected').data('regional-police-id');
            var movedOfficerLeaderPhone = $('#officerLeaderMovedOption').find(':selected').data('phone');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegionalPoliceForm').select2({
                        dropdownParent: $('#movedOfficerLeaderRegionalPoliceForm').parent(),
                        theme: 'bootstrap4',
                        width: '100%'
                    });
                },
            ...
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegionalPoliceForm').on('change', function(){
                // call ajax get police
                $.ajax({
                    url: "{{ route('doc.surat-perintah-penyidikan-document.api.polices', ['accident_id' => $accidentId]) }}",
                    type: "GET",
                    ...
                    success: function(response) {
                        ...
                        // Populate options based on response data
                        var polices = response.data;
                        $('#movedOfficerLeaderResortPoliceForm').append($('<option>', {
                            value: '',
                            text: '--Pilih Polres--',
                        }));
                        $.each(polices, function(index, police) {
                        ...
                        $('#addMovedOfficerLeaderModal #movedOfficerLeaderResortPoliceForm').select2({
                            dropdownParent: $('#movedOfficerLeaderResortPoliceForm').parent(),
                            theme: 'bootstrap4',
                            width: '100%'
                        });
                    },
            ...
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegisterNumberForm').val(movedOfficerLeaderRegisterNumber);
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderRankForm').val(movedOfficerLeaderRankId).trigger('change');
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderFirstNameForm').val(movedOfficerLeaderName);
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderPhoneForm').val(movedOfficerLeaderPhone);
            $('#addMovedOfficerLeaderModal #movedOfficerLeaderPositionForm').val(movedOfficerLeaderPosition).trigger('change');
        });

        $('#saveAddMovedOfficerLeaderForm').on('click', function() {
            var movedOfficerLeaderRegisterNumber = $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegisterNumberForm').val();
            var movedOfficerLeaderRankId = $('#addMovedOfficerLeaderModal #movedOfficerLeaderRankForm').find(':selected').val();
            var movedOfficerLeaderRankName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderRankForm').find(':selected').data('rank-name');
            var movedOfficerLeaderFirstName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderFirstNameForm').val();
            var movedOfficerLeaderLastName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderLastNameForm').val();
            var movedOfficerLeaderFullName = movedOfficerLeaderFirstName + ' ' + movedOfficerLeaderLastName;
            var movedOfficerLeaderPhone = $('#addMovedOfficerLeaderModal #movedOfficerLeaderPhoneForm').val();
            var movedOfficerLeaderPositionId = $('#addMovedOfficerLeaderModal #movedOfficerLeaderPositionForm').find(':selected').val();
            var movedOfficerLeaderPositionName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderPositionForm').find(':selected').data('position-name');
            var movedOfficerLeaderRegionalPoliceId = $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegionalPoliceForm').find(':selected').val();
            var movedOfficerLeaderRegionalPoliceName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegionalPoliceForm').find(':selected').data('regional-police-name');
            var movedOfficerLeaderResortPoliceId = $('#addMovedOfficerLeaderModal #movedOfficerLeaderResortPoliceForm').find(':selected').val();
            var movedOfficerLeaderResortPoliceName = $('#addMovedOfficerLeaderModal #movedOfficerLeaderResortPoliceForm').find(':selected').data('resort-police-name');
            var movedOfficerLeaderPoliceName = (movedOfficerLeaderResortPoliceName) ? movedOfficerLeaderRegionalPoliceName + ' - ' + movedOfficerLeaderResortPoliceName : movedOfficerLeaderRegionalPoliceName;
            // Validation
            if(movedOfficerLeaderRegisterNumber == '' || movedOfficerLeaderRankId == '' || movedOfficerLeaderFirstName == '' || movedOfficerLeaderPhone == '' || movedOfficerLeaderPositionId == '' || movedOfficerLeaderRegionalPoliceId == '') {
                //Append small element text error
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegisterNumberForm').parent().append('<small id="movedOfficerLeaderRegisterNumberFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderRankForm').parent().append('<small id="movedOfficerLeaderRankFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderFirstNameForm').parent().append('<small id="movedOfficerLeaderFirstNameFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderPhoneForm').parent().append('<small id="movedOfficerLeaderPhoneFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderPositionForm').parent().append('<small id="movedOfficerLeaderPositionFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
                $('#addMovedOfficerLeaderModal #movedOfficerLeaderRegionalPoliceForm').parent().append('<small id="movedOfficerLeaderRegionalPoliceFormError" class="form-text text-danger">Kolom ini wajib diisi.</small>');
    ...
    $(document).ready(function() {
        $('#suratPerintahPenyidikanApproveValidationFormSubmit').on('click', function(e) {
            e.preventDefault();
