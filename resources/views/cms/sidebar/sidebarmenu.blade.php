<div class="min-vh-100 p-2">
    ...
    <ul class="nav nav-pills flex-column mt-2" id="menu">
        ...
        <li class="nav-item mb-2">
            <a href="{{ route('cms.validation-dashboard-irsms-icell') }}"
                ...
                <i class="bi bi-box-arrow-up-right text-white ms-2 small"></i> <!-- Ikon untuk menunjukkan link eksternal -->
            </a>
        </li>
	...
	<li class="nav-item mb-2">
            <a href="{{ route('cms.document-return.index') }}"
                class="nav-link parents-menu d-flex align-items-center {{ request()->routeIs('document-return.*') ? 'active' : '' }}">
        ...
        <li class="nav-item mb-2">
            ...
            <ul class="nav flex-column flex-nowrap collapse {{ request()->routeIs('ticketing.*') ? 'show' : '' }}" id="ticketing" data-bs-parent="#menu">
                <li class="nav-item items-child my-1">
                    <a href="{{ route('ticketing.open') }}" class="nav-link child-menu text-decoration-none text-white ps-5 {{ request()->routeIs('ticketing.open') ? 'active' : '' }}">Open (New)</a>
                </li>
                <li class="nav-item items-child my-1">
                    <a href="{{ route('ticketing.pending') }}" class="nav-link child-menu text-decoration-none text-white ps-5 {{ request()->routeIs('ticketing.pending') ? 'active' : '' }}">Pending (&gt;3 days)</a>
                </li>
                <li class="nav-item items-child my-1">
                    <a href="{{ route('ticketing.solved') }}" class="nav-link child-menu text-decoration-none text-white ps-5 {{ request()->routeIs('ticketing.solved') ? 'active' : '' }}">Solved</a>
                </li>
            </ul>
        </li>
            ...
            <ul class="nav flex-column flex-nowrap collapse" id="databases" data-bs-parent="#menu">
                <li class="nav-item items-child my-1">
                    <a href="{{ route('cms.db.postgresql.query.index') }}"
                        class="nav-link child-menu text-decoration-none text-white ps-5">Postgresql - Query</a>
                </li>
            </ul>
        </li>
