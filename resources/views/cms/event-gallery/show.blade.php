...
@section('content')    
    ...
    <a class="btn-back" href="{{ route('cms.event-gallery.index') }}"><i class="bi bi-arrow-left"></i>Kembali ke Halaman Event Gallery</a>

        <div class="box">
            <div class="box-header">
                <h3 class="fw-bold text-blue-dark">{{ $title }}</h3>
            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mt-3">31 Desember 2024</p>
                                            <a href="{{route('cms.event-gallery.show', ['id' => 0])}}" class="btn btn-primary">
