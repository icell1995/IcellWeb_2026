...
@section('_title', 'Report Riview Mindik ' . $rangeDate)
...
@section('content')   
    ...
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="fw-bold text-blue-dark"> Report Riview Mindik ({{ $rangeDate }})
        </div>
        <div class="boxy-body mt-4 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('cms.case-document-validation-report.index') }}" method="GET">
                        <div class="mb-3 mt-2">
                    ...
                    <tbody
                        ...
                        @foreach($reports as $report)
                            <tr>
                                ...
                                <td class="text-center align-middle">{{ $report->document_category_name }}</td>
                                <td class="text-center align-middle">{{ $report->document_number }}</td>
                                <td class="text-center align-middle">{{ Carbon\Carbon::parse($report->approved_at)->locale('id')->translatedFormat('d F Y H:i:s') . ' WIB' }}</td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#startApprovedDate').datepicker({
                ...
                $('#endApprovedDate').datepicker('setStartApprovedDate', startApprovedDate);
            });
            $('#startApprovedDate').keydown(function(e) {
                e.preventDefault();
                return false;
            })
            ...
            $('#endApprovedDate').datepicker({
                ...
                $('#startApprovedDate').datepicker('setEndApprovedDate', endApprovedDate);
            });
            $('#endApprovedDate').keydown(function(e) {
                e.preventDefault();
                return false;
            });
        });
