...
<div class="box">
    <div class="box-header">
        <h4 class="fw-bold text-blue-dark">Tambah Terlapor</h4>
    ...
    <div class="boxy-body">
        <form
            action="{{ route('case.participant.reported-person.store', ['accidentId' => $accidentId, 'accident_id' => request()->query('accident_id')]) }}"
