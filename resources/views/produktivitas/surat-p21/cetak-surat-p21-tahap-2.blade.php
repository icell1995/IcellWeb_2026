            ...
            <form target="_blank" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 pb-4">
                    <textarea class="form-control inline-block txtarea" style="white-space: pre-line;" disabled>
                        a. Undang-Undang Nomor 8 Tahun 1981 tentang Hukum Acara Pidana (KUHAP) Pasal 109 ayat (1);
                        ...
                        e. Surat Perintah Penyidikan Nomor : {{$no_spdp}}, tanggal {{$spdp_date}}.
                    </textarea>
                </div>
                ...
                <button class="btn btn-primary float-right mr-4">
                    <a href="{{url('createword-surat-p21-tahap-2/'.$accident->id)}}" style="color: #ffffff">Generate</a>
                </button>
            </form>
        </div>
    </div>
