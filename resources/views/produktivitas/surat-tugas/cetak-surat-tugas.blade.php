        ...
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name=""
                            disabled>Bahwa untuk kepentingan penyelidikan dan penyidikan tindak pidana serta untuk melakukan tindakan hukum berupa penangkapan tersangka, maka perlu mengeluarkan surat perintah tugas ini.</textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name="" disabled>1. Pasal 5 ayat (2), Pasal 7 ayat (1) huruf d, Pasal 11, Pasal 16, Pasal 18 ayat(1) dan Pasal 19 ayat (2) KUHP &#13;&#10;2. Undang-Undang Republik Indonesia Nomor 2 Tahun 2002 tentang Kepolisian Negara Republik Indonesia&#13;&#10;3. Udang-Undang Republik Indonesia Nomor 22 Tahun 2009 tentang Lalu Lintas dan Angkutan Jalan&#13;&#10;4. Laporan Polisi Nomor : , tanggal 25 Desember 2020
                        </textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name=""
                            disabled>1. Melakukan penyidikan terhadap kecelakaan lalu lintas yang terjadi pada Hari ............. tanggal {{$accident_date }} sekira pukul {{$accident->accident_time}} di {{$accident->road_name}}&#13;&#10;2. Surat Perintah ini belaku mulai tanggal dikeluarkan sampai dengan penyidikan selesai&#13;&#10;3. Melaksanakan perintah dengan rasa tanggung jawab dan melaporkan hasilnya</textarea>
                    </div>
                </div>

                <button type="button" class="btn btn-primary float-right mr-4">
                    <a href="{{url('createword-surat-tugas/'.$accident->id)}}" style="color: #ffffff">Generate</a>
                </button>
