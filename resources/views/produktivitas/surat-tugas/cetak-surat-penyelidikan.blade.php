        ...
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name=""
                            disabled>Bahwa untuk kepentingan penyelidikan tindak pidana, maka perlu mengeluarkan surat perintah ini.</textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name="" id="" disabled>@foreach ($surat_perintah_penyelidikan as $lidik ){{$lidik->rank_id}} {{$lidik->first_name}} {{$lidik->last_name}} NRP {{$lidik->id}}&#13;&#10;{{$lidik->position_short_name}} &#13;&#10;@endforeach</textarea>
                    </div>
                </div>
                ...
                <button type="button" class="btn btn-primary float-right mr-4">
                    <a href="{{url('createword-surat-penyelidikan/'.$accident->id)}}" style="color: #ffffff">Generate</a>
                </button>
