...
@section('content')
    <div class="content col-xs-12 col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="box">
            ...
            <form action="{{ route('lhgp.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" name="accident_id_lhgp" id="accident_id_lhgp" value="{{ $accidentId }}" hidden>
                <fieldset class="border p-2 mt-4">
                    <legend class="w-auto text-legend font-weight-bold m-0" style="font-size: 1.2rem">Laporan Hasil Gelar
                        Perkara</legend>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 com-12 form-group">
                            ...
                            <input type="text" class="form-control" id="nomor_sprindik" name="nomor_sprindik"
                                value="{{ $sprindik->document_number }}" readonly>
                        </div>
                ...
                <fieldset class="border p-2 mt-2">
                    <legend class="w-auto text-legend font-weight-bold m-0" style="font-size: 1.2rem">Pelaksanaan</legend>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            ...
                            <input id="surat_undangan" class="form-control" type="text" name="surat_undangan"
                                value="{{ old('surat_undangan') }}" required autocomplete="surat_undangan" autofocus
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            ...
                            <input id="tanggal_pelaksanaan" type="text"
                                ...
                                value="{{ old('tanggal_pelaksanaan') }}" data-provide="datepicker">
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="time" class="form-control text-center" id="waktu_pelaksanaan"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            ...
                            <input id="tempat_pelaksanaan" class="form-control" type="text" name="tempat_pelaksanaan"
                                value="{{ old('tempat_pelaksanaan') }}" required autocomplete="tempat_pelaksanaan"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            ...
                            <input id="pimpinan_gelar" class="form-control" type="text" name="pimpinan_gelar"
                                value="{{ old('pimpinan_gelar') }}" required autocomplete="pimpinan_gelar" autofocus
                                placeholder="*contoh: AKP nama_test (Kasat Lantas Polres....)">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 form-group">
                            <span class="font-weight-bold">Pemapar :</span>
                            <input id="pemapar" class="form-control" type="text" name="pemapar"
                                value="{{ old('pemapar') }}" required autocomplete="pemapar" autofocus
                ...
                <fieldset class="border p-2 mt-2">
                    <legend class="w-auto text-legend font-weight-bold m-0" style="font-size: 1.2rem">Pembahasan</legend>
                    <div class="col-12 form-group">
                        <span class="font-weight-bold">Pembahasan :</span>
                        <textarea class="form-control" name="pembahasan" id="pembahasan" style="height: auto;"></textarea>
                    </div>
                    <div class="col-12 form-group">
                        <span class="font-weight-bold">Kesimpulan :</span>
                        <textarea class="form-control" name="kesimpulan" id="kesimpulan" style="height: auto;"></textarea>
                    </div>
                    <div class="col-12 form-group">
                        <span class="font-weight-bold">Penutup :</span>
                        <textarea class="form-control" name="penutup" id="penutup" style="height: auto;"></textarea>
                    </div>
                </fieldset>

                <fieldset class="border p-2 mt-2">
                    <legend class="w-auto text-legend font-weight-bold m-0" style="font-size: 1.2rem">Penandatangan Surat
                    </legend>
                    <div class="col-12">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('#tambah-tersangka').click(function() {
            $('#modalTersangka').show();
            // document.getElementById("#modalTersangka").style.display = "block";
        });
