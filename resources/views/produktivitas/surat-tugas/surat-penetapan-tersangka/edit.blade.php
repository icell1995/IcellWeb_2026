...
<div class="content col-xs-12 col-md-12 col-lg-12 col-sm-12">
    ...
    <div class="box">
        ...
        <form action="{{ route('sddl.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <input id="letter_number" type="text"
                                            ...
                                            value="{{$sddl->letter_number}}" required autocomplete="letter_number" autofocus placeholder="Masukkan Nomor Surat Ketatapan Tentang Penetapan Tersangka">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        ...
                                        value="{{Carbon\Carbon::parse($sddl->letter_date)->format('d-m-Y')}}" data-provide="datepicker">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <input id="no_lp" type="text"
                                            ...
                                            value="{{$sddl->no_lp}}" required autocomplete="no_lp" autofocus placeholder="" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <input id="no_sprindik" type="text"
                                            ...
                                            value="{{$letter_number}}" required autocomplete="no_sprindik" autofocus placeholder="" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <select name="kejaksaan" id="kejaksaan" class="form-control @error('kejaksaan') is-invalid @enderror" type="">
                                            ...
                                            @foreach ($name as $kj)
                                                <option value="{{ $kj->id }}" @if($kj->id == $sddl->prosecutor_office_id) selected="selected" @endif>{{ $kj->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <select name="letter_signature" id="letter_signature" class="form-control @error('letter_signature') is-invalid @enderror">
                                            ...
                                            @foreach($authorizedSignatories as $data)
                                                <option value="{{$data->id}}" @if($data->id == $sddl->signing_officials) selected="selected" @endif>{{$data->register_number . ' - ' . $data->full_name . ' | ' . $data->position_id}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3" id="gelar_perkara" style="display: none;">
                                    ...
                                    <div class="input-group" style="padding: 0px">
                                        <input id="tgl_gelar" type="text"
                                            ...
                                            value="{{carbon\carbon::parse($sddl->tgl_gelar)->format('Y-m-d') }}" required autocomplete="tgl_gelar" autofocus placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
