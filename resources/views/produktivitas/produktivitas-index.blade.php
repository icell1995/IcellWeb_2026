    ...
    <div class="box">
        <div class="box-header">
            ...
            <form method="GET" class="row mt-2 search" action="{{ route('produktivitas-search') }}">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-12 mb-3">
                    <select id="polda" name="polda" class="form-select select2 @error('polda') is-invalid @enderror">
                        @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            <option value="-">Semua Polda</option>
                        @endif
                        @foreach ($poldas as $polda)
                            @if(in_array($polda->name, ['POLDA XE', 'PJR INDUK KORLANTAS', 'PUSDIKLANTAS', 'DIT GAKKUM KORLANTAS']))
                                @continue
                            @endif
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-12 mb-3">
                    <select id="polres" name="polres" class="form-select select2 @error('polres') is-invalid @enderror">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="row col-12 mb-1">
                                    ...
                                    @php
                                        ...
                                        $isRole1Or2 = in_array((int) Auth::user()->role_id, [1, 2], true);
                                        $softOpen  = $isRole1Or2 && $locked; // role 1 & 2: modal muncul tapi boleh lanjut
                                    @endphp

                                    <a class="col-7 p-0 text-link lp-link"
                                    href="{{ $locked && !$isRole1Or2 ? '#' : $detailUrl }}"
