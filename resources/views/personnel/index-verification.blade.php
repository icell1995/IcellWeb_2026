...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="fw-bold text-blue-dark"> Daftar Anggota Menunggu Verifikasi- SAT LANTAS
                                    ...
                                    @if ($user->officer->is_valid == false)
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                @else
                                                    @if ($user->officer->status == 'PRESENT' || $user->officer->status == 'ASSISTANCE')
                                                        <h6><span class="badge bg-success">Aktif</span></h6>
                                                    @elseif($user->officer->status == 'EXIT')
                                                        <h6><span class="badge bg-danger">Keluar</span></h6>
                                                    @elseif($user->officer->status == 'RETIRE')
                                                        <h6><span class="badge bg-secondary">Pensiun</span></h6>
                                                    @endif
                                                @endif
                                            </td>
                                            <td class="text-center align-middle">
