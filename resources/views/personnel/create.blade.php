...
<div class="box">
    <div class="box-header">
        <h4 class="fw-bold text-blue-dark">Tambah Personnel</h4>
    ...
    <div class="boxy-body">
        <form
            action="{{ route('personnel.store', ['policeId' => $policeId]) }}"
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input class="form-control" id="birthDate" name="birthDate" placeholder="YYYY-MM-DD" autocomplete="off"
                        value="{{ old('birthDate') }}" data-provide="datepicker">
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="registerNumber" type="text" class="form-control @error('registerNumber') is-invalid @enderror"
                        name="registerNumber" value="{{ old('registerNumber') }}"
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 align-self-center">
                    <div class="input-group">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror"
                            ...
                            placeholder="Email akan dibuat otomatis berdasarkan NRP yang diinput" readonly>
                    </div>
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                    ...
                    @enderror
                    <small class="text-muted d-block mt-1">(*Email akan dibuat otomatis berdasarkan NRP dengan format: nrp@polri.go.id)</small>
                </div>
            </div>
                    ...
                    <div class="mt-4" style="display: none;"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isRegisterSignatory"
                                ...
                                @if (old('isRegisterSignatory') == 'true') checked @endif>
                        ...
                        <div class="input-group row mb-3 ms-0">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                                <input id="registerSignatoryIdentityNumber" type="text"
                                    ...
                                    value="{{ old('registerSignatoryIdentityNumber') }}"
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="educationInstitutionName" type="text"
                        ...
                        value="{{ old('educationInstitutionName') }}"
                    ...
                    <select class="form-control select2" name="policeDiktukEducation" id="policeDiktukEducation">
                        ...
                        @foreach ($policeDiktukEducations as $policeDiktukEducation)
                            <option value="{{ $policeDiktukEducation->id }}"
                                {{ old('policeDiktukEducation') == $policeDiktukEducation->id ? 'selected' : '' }}>
            ...
            <div class="input-group row mb-3 ms-0">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                    <input id="policeDiktukEducationGraduateYear" type="text"
                        ...
                        value="{{ old('policeDiktukEducationGraduateYear') }}"
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isRegisterAdmin"
                                ...
                                @if (old('isRegisterAdmin') == 'true') checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isRegisterAdminCanEntryDocument"
                                ...
                                @if (old('isRegisterAdminCanEntryDocument') == 'true') checked @endif>
            ...
            @elseif(Auth::user()->role_id == 3 && Auth::user()->police_id != $policeId)
                ...
                <input type="hidden" name="isRegisterAdminCanEntryDocument" value="false">
            @else
                <input type="hidden" name="isRegisterAdmin" value="false">
                <input type="hidden" name="isRegisterAdminCanEntryDocument" value="false">
            @endif
            ...
            <div class="box-header">
                <h5 class="fw-bold text-blue-dark">PENDIDIKAN LANTAS / DIKJUR</h5>
            </div>
            ...
            <div class="row">
                <div class="col-12 my-2">
                            ...
                            <div class="mb-3">
                                <div class="icheck-primary">
                                    <input type="radio" id="existsOfficerSkepPenyidik" name="isExistsOfficerSkepPenyidik"
                                        value="true" @if (old('isExistsOfficerSkepPenyidik') == true) checked @endif>
                                ...
                                <div class="icheck-primary">
                                    <input type="radio" id="notExistsOfficerSkepPenyidik"
                                        ...
                                        @if (old('isExistsOfficerSkepPenyidik') == false) checked @endif>
                    ...
                    <div id="officerSkepPenyidikSection" @if (old('isExistsOfficerSkepPenyidik') == false) style="display:none;" @endif>
                        <div class="input-group row mb-3 ms-0">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                                <input id="officerSkepPenyidikNumber" type="text"
                                    ...
                                    value="{{ old('officerSkepPenyidikNumber') }}"
            ...
            <div class="box-header">
                <h5 class="fw-bold text-blue-dark">RIWAYAT SERTIFIKASI</h5>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div id="officerCertificateSection" @if (!empty(old('isExistsOfficerCertificate')) && old('isExistsOfficerCertificate') == false) style="display:none;" @endif>
                        <div id="certificate">
                            <div class="row">
                                <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#saveAddCertificateButton').on('click', function() {
                ...
                if (certificateTypeId == '' || certificateNumber == '' || certificateStartDate == '' || certificateEndDate == '') {
                    // Remove small text error di bawah inputan
                ...
                // Clear inputan
                $('#addCertificateModal #certificateType').val(null).trigger('change');
