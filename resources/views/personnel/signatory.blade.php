...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="fw-bold text-blue-dark"> Daftar Pejabat TTE Sudah Aktivasi Dan Tanda Tangan
                                            ...
                                            @else
                                                <div class="d-grid gap-2">
                                                    <button type="button" class="btn btn-md btn-success"
                                                        disabled>Sudah Aktif Memiliki TTE</button>
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center align-middle">
