...
<div class="box">
    <div class="box-header">
        <h4 class="fw-bold text-blue-dark">Validasi Personnel</h4>
    ...
    <div class="boxy-body">
        <form
            ...
            @if(Auth::user()->isAdminHeadquarter() || Auth::user()->isSignatoryPolice())
                <div class="input-group row mb-3 ms-0">
        ...
        <form method="POST" action="{{ route('personnel.validation.process', ['id' => $officer->id, 'policeId' => $policeId]) }}" id="validationForm">
            @csrf
            <input type="hidden" name="id" value="{{ $officer->id }}">
            <input type="hidden" name="policeId" value="{{ $policeId }}">

            {{-- Button --}}
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-primary mx-1" id="btnApprove">
