        ...
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center">
                    <h3><span class="pb-1 border-bot  font-weight-bolder">SURAT KETETAPAN TENTANG PENETAPAN TERSANGKA</span></h3>
                    <h4 class="pt-1 pb-2 font-weight-bolder">NOMOR : {{$suratKetetapanTentangPenetapanTersangkaDocument->document_number}}</h4>
                </div>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                ...
                                5. Surat Perintah Penyidikan Nomor : {{$suratKetetapanTentangPenetapanTersangkaDocument->suratPerintahPenyidikanDocument->document_number}}, tanggal {{Carbon\Carbon::parse($suratKetetapanTentangPenetapanTersangkaDocument->suratPerintahPenyidikanDocument->document_date)->locale('id')->translatedFormat('d F Y')}}<br/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                Laporan Hasil Gelar Perkara, tanggal {{Carbon\Carbon::parse($suratKetetapanTentangPenetapanTersangkaDocument->laporanHasilGelarPerkaraDocument->document_date ?? null)->locale('id')->translatedFormat('d F Y')}}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <button type="button" class="btn btn-primary btn-lg float-right mr-4">
                    <a href="{{route('doc.surat-ketetapan-tentang-penetapan-tersangka-document.download', ['id'=> $suratKetetapanTentangPenetapanTersangkaDocumentId,'accident_id' => $accident->id])}}" style="color: #ffffff"><i class="fa fa-download"></i> Download</a>
                </button>
