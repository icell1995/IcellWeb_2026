@php
    $_title = 'S.Ket Penetapan Tersangka';
@endphp
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            <form
                action="{{ route('doc.surat-ketetapan-tentang-penetapan-tersangka-document.store', ['accident_id' => $accidentId]) }}"
                method="POST" enctype="multipart/form-data" id="suratKetetapanTentangPenetapanTersangkaForm" novalidate>
                @csrf
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-3 col-form-label" for="suspectSource">Sumber Yang Menyebutkan Tersangka<span class="text-danger fs-5">*</span>
                    </label>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <select class="form-control select2" name="suspectSource" id="suspectSource">
                            <option value="">--Pilih Sumber--</option>
                            @foreach ($suspectSources as $suspectSource)
                                <option value="{{ $suspectSource->id }}" data-code="{{ $suspectSource->code }}">
                                    {{ $suspectSource->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0" id="resumeSuspectDeterminationDateSection" style="display: none;">
                    <label class="fw-bold col-sm-3 col-form-label">Tanggal Resume Penetapan Tersangka<span class="text-danger fs-5">*</span></label>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input class="form-control datepicker" id="resumeSuspectDeterminationDate"
                            name="resumeSuspectDeterminationDate" placeholder="YYYY-MM-DD" autocomplete="off"
                            value="{{ old('resumeSuspectDeterminationDate') }}" data-provide="datepicker">
                ...
                <div class="input-group row mb-3 ms-0" id="laporanHasilGelarPerkaraDocumentSuspectDeterminationSection"
                    style="display: none;">
                        ...
                        <select class="form-control select2" name="laporanHasilGelarPerkaraDocumentSuspectDetermination"
                            ...
                            @foreach ($laporanHasilGelarPerkaraDocumentSuspectDeterminations as $laporanHasilGelarPerkaraDocumentSuspectDetermination)
                                <option value="{{ $laporanHasilGelarPerkaraDocumentSuspectDetermination->id }}">
                                    {{ Carbon\Carbon::parse($laporanHasilGelarPerkaraDocumentSuspectDetermination->document_date)->locale('id')->translatedFormat('l') .', ' .Carbon\Carbon::parse($laporanHasilGelarPerkaraDocumentSuspectDetermination->document_date)->locale('id')->translatedFormat('d F Y') }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0" id="suspectSection" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="col-sm-3 d-none">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="isUnknownMaritalStatusFieldSuspect"
                                            name="isUnknownMaritalStatusFieldSuspect" value="true" aria-label="..." disabled>
                            ...
                            <div class="countryChildrenLocationSectionSuspect">
                                ...
                                <div class="input-group row mb-3 ms-0">
                                    <label class="fw-bold col-sm-3 col-form-label"
                                        for="villageFieldSuspect">Kelurahan/Desa<span class="text-danger fs-5">*</span></label>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#suspectSource').on('change', function() {
                ...
                if (suspectSourceCode == 'SS-SKTPT-TDDDLP') {
                        ...
                        success: function(response) {
                            ...
                            $.each(data, function(index, data) {
                                suspect.append($('<option>', {
                                    ...
                                    "data-identity-type-id": (data
                                            .identity_type_id) ? data
                                        .identity_type_id : '',
                                    "data-identity-number": (data
                                            .identity_number) ? data
                                        .identity_number : '',
                                    "data-name": data.name,
                                    "data-gender-id": (data.gender_id) ?
                                        data.gender_id : '',
                                    "data-birth-place": (data.birth_place) ?
                                        data.birth_place : '',
                                    "data-birth-date": (data.birth_date) ?
                                        data.birth_date : '',
                                    "data-father-name": (data.father_name) ?
                                        data.father_name : '',
                                    "data-mother-name": (data.mother_name) ?
                                        data.mother_name : '',
                                    "data-nationality": (data.nationality) ?
                                        data.nationality : '',
                                    "data-ethnic-id": (data.ethnic_id) ?
                                        data.ethnic_id : '',
                                    "data-job-id": (data.job_id) ? data
                                        .job_id : '',
                                    "data-religion-id": (data.religion_id) ?
                                        data.religion_id : '',
                                    "data-education-id": (data
                                        .education_id) ? data.education_id :
                                        '',
                                    "data-marital-status-id": (data
                                            .marital_status_id) ? data
                                        .marital_status_id : '',
                                    ...
                                    "data-province-id": (data.province_id) ?
                                        data.province_id : '',
                                    "data-regency-id": (data.regency_id) ?
                                        data.regency_id : '',
                                    "data-district-id": (data.district_id) ?
                                        data.district_id : '',
                                    "data-village-id": (data.village_id) ?
                                        data.village_id : '',
                                    "data-address": (data.address) ? data
                                        .address : '',

                                    "data-is-available-email": (data
                                            .properties) ? data.properties
                                        .is_available_email : null,
                                    "data-is-available-phone-number": (data
                                            .properties) ? data.properties
                                        .is_available_phone_number : null,
                                    "data-is-exists-email": (data
                                            .properties) ? data.properties
                                        .is_exists_email : null,
                                    "data-is-exists-phone-number": (data
                                            .properties) ? data.properties
                                        .is_exists_phone_number : null,
                                    "data-is-unknown-address": (data
                                            .properties) ? data.properties
                                        .is_unknown_address : null,
                                    "data-is-unknown-birth-date": (data
                                            .properties) ? data.properties
                                        .is_unknown_birth_date : null,
                                    "data-is-unknown-birth-place": (data
                                            .properties) ? data.properties
                                        .is_unknown_birth_place : null,
                                    "data-is-unknown-father": (data
                                            .properties) ? data.properties
                                        .is_unknown_father : null,
                                    "data-is-unknown-mother": (data
                                            .properties) ? data.properties
                                        .is_unknown_mother : null,
                                    "data-is-unknown-nationality": (data
                                            .properties) ? data.properties
                                        .is_unknown_nationality : null,
                                    "data-is-unknown-gender": (data
                                            .properties) ? data.properties
                                        .is_unknown_gender : null,
                                    "data-is-unknown-marital-status": (data
                                            .properties) ? data.properties
                    ...
                    $(document).on('change', '#laporanHasilGelarPerkaraDocumentSuspectDetermination',
                        function() {
                                    ...
                                    success: function(response) {
                                        ...
                                        $.each(data, function(index, data) {
                                            suspect.append($('<option>', {
                                                ...
                                                "data-is-available-email": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_available_email :
                                                    null,
                                                "data-is-available-phone-number": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_available_phone_number :
                                                    null,
                                                "data-is-exists-email": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_exists_email :
                                                    null,
                                                "data-is-exists-phone-number": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_exists_phone_number :
                                                    null,
                                                "data-is-unknown-address": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_address :
                                                    null,
                                                "data-is-unknown-birth-date": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_birth_date :
                                                    null,
                                                "data-is-unknown-birth-place": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_birth_place :
                                                    null,
                                                "data-is-unknown-father": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_father :
                                                    null,
                                                "data-is-unknown-mother": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_mother :
                                                    null,
                                                "data-is-unknown-nationality": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_nationality :
                                                    null,
                                                "data-is-unknown-gender": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_gender :
                                                    null,
                                                "data-is-unknown-marital-status": (
                                                        data.properties
                                                        ) ? data
                                                    .properties
                                                    .is_unknown_marital_status :
                                                    null,
            ...
            $(document).on('change', '#suspect', function() {
                ...
                if (is_exists_email == true || is_exists_email == "true") {
                    $('#existsEmailFieldSuspect').prop('checked', true);
                    $('#notExistsEmailFieldSuspect').prop('checked', false);
                    $('#emailFieldSuspect').prop("disabled", false);
                } else {
                    $('#existsEmailFieldSuspect').prop('checked', false).trigger('change');
                ...
                if (is_exists_phone_number == true || is_exists_phone_number == "true") {
                    $('#existsPhoneNumberFieldSuspect').prop('checked', true);
                    $('#notExistsPhoneNumberFieldSuspect').prop('checked', false);
                    $('#phoneNumberFieldSuspect').prop("disabled", false);
                } else {
                    $('#existsPhoneNumberFieldSuspect').prop('checked', false).trigger('change');
                ...
                /*if(countryId == 'C101'){
                    ...
                    var parentId = $('#countryFieldSuspect').find(':selected').val();
        ...
        $(document).ready(function() {
            ...
            function validateSuspectIdentityNumber() {
                var $field = $('#identityNumberFieldSuspect');
                var identityTypeId = $('#identityTypeFieldSuspect').val();
                var identityTypeName = ($('#identityTypeFieldSuspect').find(':selected').data('identity-type-name') || $('#identityTypeFieldSuspect').find(':selected').text() || '').toUpperCase();
            ...
            $('#identityNumberFieldSuspect').on('input keyup change blur', function() {
                var val = ($(this).val() || '').trim();
                if (val !== '') {
                    validateSuspectIdentityNumber();
                }
            });
            $('#identityTypeFieldSuspect').on('change select2:select', function() {
            ...
            function validateSuspectPhoneAndEmail() {
                // Phone validation
                var $phoneField = $('#phoneNumberFieldSuspect');
                ...
                // Email validation
                var $emailField = $('#emailFieldSuspect');
            ...
            $(document).on('change', 'input[name="isExistsPhoneNumberFieldSuspect"]', function() {
                var isExistsPhoneNumberFieldSuspect = $(
                    'input[name="isExistsPhoneNumberFieldSuspect"]:checked').val();
                ...
                if (isExistsPhoneNumberFieldSuspect == 'true') {
                    ...
                    if (lastPhoneNumber == 'TIDAK ADA NOMOR TELEPON' || lastPhoneNumber ==
                        'TIDAK BERSEDIA MEMBERIKAN NOMOR TELEPON') {
            ...
            function clearFieldError($field) {
                ...
                $field.next('.frontend-error, .invalid-feedback').remove();
                $field.siblings('.frontend-error, .invalid-feedback').remove();
                $field.closest('.input-group, .mb-3, .col-lg-9, .col-md-9, .col-lg-6, .col-md-6, div').find('.frontend-error, .invalid-feedback').remove();
            }
            ...
            $(document).on('input change changeDate dp.change keyup blur', 'input, textarea, select', function() {
                var $field = $(this);
                // Jangan auto-clear untuk field yang punya validasi format khusus
                if ($field.is('#identityNumberFieldSuspect, #phoneNumberFieldSuspect, #emailFieldSuspect, #documentNumber')) {
                    return;
                }
            ...
            // Validator khusus no dokumen
            $('#documentNumber').on('input keyup change blur', function() {
                var val = ($(this).val() || '').trim();
                if (val && val.length >= 5 && /^(?=.*[a-zA-Z])(?=.*[0-9])(?=.*\/)/.test(val)) {
                    clearFieldError($(this));
                }
            });

            // Continuous watcher untuk membersihkan highlight jika value sudah terisi (kecuali field berformat khusus)
            setInterval(function() {
            ...
            $('#suratKetetapanTentangPenetapanTersangkaFormSubmit').on('click', function(e) {
                ...
                // Sumber Tersangka
                if (!suspectSource) {
                    markError('#suspectSource', 'Sumber Tersangka harus dipilih');
                }
                ...
                // === FIELD DETAIL TERSANGKA JIKA TERSANGKA DIPILIH / FORM DETAIL TAMPIL ===
                if ($('#suspectDetail').is(':visible') || suspectSource === '5' || $('#suspect').val()) {
                ...
                var idErr = validateSuspectIdentityNumber();
                if (idErr) {
                    errors.push(idErr);
                }
                validateSuspectPhoneAndEmail();
                if ($('#phoneNumberFieldSuspect').hasClass('is-invalid')) {
                    var phoneErr = $('#phoneNumberFieldSuspect').next('.frontend-error').text() || 'Nomor telepon tidak valid';
                    errors.push(phoneErr);
                }
                if ($('#emailFieldSuspect').hasClass('is-invalid')) {
                    var emailErr = $('#emailFieldSuspect').next('.frontend-error').text() || 'Email tidak valid';
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                $('#suratKetetapanTentangPenetapanTersangkaForm')[0].submit();
                            });
                        }
                    },
                    error: function(xhr) {
