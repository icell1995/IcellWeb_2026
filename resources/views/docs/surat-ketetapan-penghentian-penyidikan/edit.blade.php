@php
    $_title = 'Edit S.Ket Penghentian Penyidikan';
@endphp
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Edit Surat Ketetapan Penghentian Penyidikan</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.surat-ketetapan-penghentian-penyidikan-document.update', ['accident_id' => $accidentId, 'id' => $document->id]) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input class="form-control @error('document_date') is-invalid @enderror" id="document_date" name="document_date"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('document_date', $document->document_date ? \Carbon\Carbon::parse($document->document_date)->format('Y-m-d') : '') }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input class="form-control @error('effective_date') is-invalid @enderror" id="effective_date" name="effective_date"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('effective_date', $document->effective_date ? \Carbon\Carbon::parse($document->effective_date)->format('Y-m-d') : '') }}"
                            data-provide="datepicker" required>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <select class="form-control select2" name="laporan_hasil_gelar_perkara_id" id="laporan_hasil_gelar_perkara_id">
                            ...
                            @foreach ($laporanHasilGelarPerkaraDocuments as $lhgp)
                                <option value="{{ $lhgp->id }}" {{ old('laporan_hasil_gelar_perkara_id', $document->laporan_hasil_gelar_perkara_id) == $lhgp->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-3 col-form-label" for="surat_pemberitahuan_dimulainya_penyidikan_id">Nomor Surat Pemberitahuan Dimulainya Penyidikan (SPDP)<span class="text-danger fs-5">*</span></label>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <select class="form-control select2 @error('alasan_penghentian') is-invalid @enderror" 
                            ...
                            @foreach($alasanPenghentianOptions as $key => $label)
                                <option value="{{ $key }}" {{ old('alasan_penghentian', $document->alasan_penghentian) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <textarea class="form-control" id="menetapkan_alasan" name="menetapkan_alasan" rows="3"
                                  placeholder="Jelaskan detail tambahan terkait alasan penghentian jika diperlukan">{{ old('menetapkan_alasan', $document->menetapkan_alasan ?? '') }}</textarea>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <select class="form-control select2 @error('prosecutor_id') is-invalid @enderror" 
                            ...
                            @foreach ($prosecutors as $prosecutor)
                                <option value="{{ $prosecutor->id }}" {{ old('prosecutor_id', $document->prosecutor_id) == $prosecutor->id ? 'selected' : '' }}>
                                    {{ $prosecutor->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <select class="form-control select2 @error('court_id') is-invalid @enderror" 
                            ...
                            @foreach ($courts as $court)
                                <option value="{{ $court->id }}" {{ old('court_id', $document->court_id) == $court->id ? 'selected' : '' }}>
                                    {{ $court->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        @php
                            $selectedSuspects = is_array(old('suspects')) ? old('suspects') : $document->suspect->pluck('id')->toArray();
                        @endphp
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input id="nomor_serah_terima" type="text"
                            ...
                            name="nomor_serah_terima" value="{{ old('nomor_serah_terima', $document->nomor_serah_terima) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input class="form-control @error('tanggal_serah_terima') is-invalid @enderror" id="tanggal_serah_terima" name="tanggal_serah_terima"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('tanggal_serah_terima', $document->tanggal_serah_terima ? \Carbon\Carbon::parse($document->tanggal_serah_terima)->format('Y-m-d') : '') }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-10 col-10">
                        <select class="form-control select2 @error('barang_bukti') is-invalid @enderror" 
                            ...
                            @foreach($daftarBarangBukti as $bb)
                                @php
                                    ...
                                    if (!is_array($selectedValues)) {
                                        $selectedValues = is_string($selectedValues) ? json_decode($selectedValues, true) : [];
                                    }
                                    $isSelected = is_array($selectedValues) && in_array($val, $selectedValues);
                                @endphp
                            ...
                            {{-- Hand-typed items currently in document but not in pool --}}
                            @if(is_array($document->barang_bukti))
                                @foreach($document->barang_bukti as $bbText)
                                    @php
                                        $inPool = $daftarBarangBukti->contains(function($poolItem) use ($bbText) {
                                            return ($poolItem->nama_barang . ' (' . $poolItem->jumlah_barang . ')') == $bbText;
                                        });
                                    @endphp
                                    @if(!$inPool)
                ...
                <input type="hidden" name="rj_nomor_kesepakatan" id="hidden_rj_nomor_kesepakatan" value="{{ old('rj_nomor_kesepakatan', $document->rj_nomor_kesepakatan) }}">
                <input type="hidden" name="rj_tanggal_kesepakatan" id="hidden_rj_tanggal_kesepakatan" value="{{ old('rj_tanggal_kesepakatan', $document->rj_tanggal_kesepakatan ? \Carbon\Carbon::parse($document->rj_tanggal_kesepakatan)->format('Y-m-d') : '') }}">
                <input type="hidden" name="rj_pihak_korban" id="hidden_rj_pihak_korban" value="{{ old('rj_pihak_korban', $document->rj_pihak_korban) }}">
                <input type="hidden" name="rj_pihak_pelaku" id="hidden_rj_pihak_pelaku" value="{{ old('rj_pihak_pelaku', $document->rj_pihak_pelaku) }}">
                <input type="hidden" name="rj_bentuk_ganti_rugi" id="hidden_rj_bentuk_ganti_rugi" value="{{ old('rj_bentuk_ganti_rugi', $document->rj_bentuk_ganti_rugi) }}">
                <input type="hidden" name="rj_nilai_ganti_rugi" id="hidden_rj_nilai_ganti_rugi" value="{{ old('rj_nilai_ganti_rugi', $document->rj_nilai_ganti_rugi) }}">
                <input type="hidden" name="rj_keterangan_tambahan" id="hidden_rj_keterangan_tambahan" value="{{ old('rj_keterangan_tambahan', $document->rj_keterangan_tambahan) }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="modal_rj_nomor_kesepakatan" placeholder="Masukkan nomor kesepakatan" value="{{ old('rj_nomor_kesepakatan', $document->rj_nomor_kesepakatan) }}">
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_tanggal_kesepakatan">Tanggal Kesepakatan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control datepicker" id="modal_rj_tanggal_kesepakatan" placeholder="YYYY-MM-DD" value="{{ old('rj_tanggal_kesepakatan', $document->rj_tanggal_kesepakatan ? \Carbon\Carbon::parse($document->rj_tanggal_kesepakatan)->format('Y-m-d') : '') }}">
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_pihak_korban">Pihak Korban <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="modal_rj_pihak_korban" rows="2" placeholder="Nama dan identitas pihak korban">{{ old('rj_pihak_korban', $document->rj_pihak_korban) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_pihak_pelaku">Pihak Pelaku <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="modal_rj_pihak_pelaku" rows="2" placeholder="Nama dan identitas pihak pelaku">{{ old('rj_pihak_pelaku', $document->rj_pihak_pelaku) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_bentuk_ganti_rugi">Bentuk Ganti Rugi <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="modal_rj_bentuk_ganti_rugi" rows="2" placeholder="Jelaskan bentuk ganti rugi yang disepakati">{{ old('rj_bentuk_ganti_rugi', $document->rj_bentuk_ganti_rugi) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_nilai_ganti_rugi">Nilai Ganti Rugi</label>
                        <input type="text" class="form-control" id="modal_rj_nilai_ganti_rugi" placeholder="Contoh: Rp 10.000.000" value="{{ old('rj_nilai_ganti_rugi', $document->rj_nilai_ganti_rugi) }}">
                    </div>
                    <div class="form-group">
                        <label for="modal_rj_keterangan_tambahan">Keterangan Tambahan</label>
                        <textarea class="form-control" id="modal_rj_keterangan_tambahan" rows="3" placeholder="Informasi tambahan lainnya">{{ old('rj_keterangan_tambahan', $document->rj_keterangan_tambahan) }}</textarea>
                    </div>
                    <div class="form-group">
...
@push('script')
    <script>
        ...
        // Check if RJ data exists on page load
        $(document).ready(function() {
            var alasanPenghentian = $('#alasan_penghentian').val();
            if (alasanPenghentian === 'RESTORATIF_JUSTICE') {
                var rjNomor = $('#hidden_rj_nomor_kesepakatan').val();
                if (rjNomor) {
                    $('#rjDataSummary').show();
                }
            }
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Trigger initial count (especially for edit mode)
            $('#barang_bukti').trigger('change');

            // Datatable for Barang Bukti Modal
            var _token = $("input[name='_token']").val();
            var accident_id = $("input[name='accident_id']").val();
            ...
            // Load existing RJ data into modal
            $('#modal_rj_nomor_kesepakatan').val($('#hidden_rj_nomor_kesepakatan').val());
            $('#modal_rj_tanggal_kesepakatan').val($('#hidden_rj_tanggal_kesepakatan').val());
            $('#modal_rj_pihak_korban').val($('#hidden_rj_pihak_korban').val());
            $('#modal_rj_pihak_pelaku').val($('#hidden_rj_pihak_pelaku').val());
            $('#modal_rj_bentuk_ganti_rugi').val($('#hidden_rj_bentuk_ganti_rugi').val());
            $('#modal_rj_nilai_ganti_rugi').val($('#hidden_rj_nilai_ganti_rugi').val());
            $('#modal_rj_keterangan_tambahan').val($('#hidden_rj_keterangan_tambahan').val());
