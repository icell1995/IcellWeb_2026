@php
    $_title = 'Surat Permohonan Penetapan Diversi';
@endphp
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah Surat Permohonan Penetapan Diversi</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.surat-permohonan-penetapan-diversi-document.store', ['accident_id' => $accidentId]) }}"
                        ...
                        <select class="form-control select2 @error('documentClassification') is-invalid @enderror" name="documentClassification" id="documentClassification">
                            ...
                            @foreach ($documentClassifications as $documentClassification)
                                <option value="{{ $documentClassification->id }}"
                                    {{ old('documentClassification') == $documentClassification->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input id="appendix" type="text"
                            ...
                            name="appendix" value="{{ old('appendix') }}" required
                        ...
                        <select class="form-control select2" name="suratPerintahPenyidikanDocument" id="suratPerintahPenyidikanDocument">
                            ...
                            @foreach ($suratPerintahPenyidikanDocuments as $spSidik)
                                <option value="{{ $spSidik->id }}"
                                    ...
                                    {{ old('suratPerintahPenyidikanDocument') == $spSidik->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input class="form-control" id="agreementDate" name="agreementDate"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('agreementDate') }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input class="form-control @error('meetingDate') is-invalid @enderror" id="meetingDate" name="meetingDate"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('meetingDate') }}"
                        ...
                        <div class="d-flex flex-column gap-2 mt-1">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="agreementResultType" id="resultOrangTua" value="ORANG_TUA"
                                    {{ old('agreementResultType', 'ORANG_TUA') == 'ORANG_TUA' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="agreementResultType" id="resultPembinaan" value="PEMBINAAN"
                                    {{ old('agreementResultType') == 'PEMBINAAN' ? 'checked' : '' }}>
                ...
                <div id="pembinaanContainer" style="{{ old('agreementResultType') == 'PEMBINAAN' ? '' : 'display: none;' }}">
                    <div class="input-group row mb-3 ms-0">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                            <input id="agreementInstitution" type="text"
                                ...
                                name="agreementInstitution" value="{{ old('agreementInstitution') }}"
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                            <div class="input-group">
                                <input id="agreementDurationMonths" type="number" min="1"
                                    ...
                                    name="agreementDurationMonths" value="{{ old('agreementDurationMonths') }}"
                        ...
                        <select class="form-control select2" name="signatory" id="signatory">
                            ...
                            @foreach ($authorizedSignatories as $data)
                                ...
                                <option value="{{ $data->id }}" data-register-number="{{ $data->register_number }}"
                                    {{ old('signatory') == $data->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-12">
                        <div id="carbonCopiesContainer">
                            @if(!empty(old('carbonCopies')))
                                @foreach (old('carbonCopies') as $carbonCopy)
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            // Toggle Hasil Kesepakatan Diversi
            ...
            // Auto-clear realtime saat user mengetik atau mengubah field
            ...
            // Trigger child load jika ada old suspectId saat validasi gagal kembali
            if ($('#suspectId').val()) {
                $('#suspectId').trigger('change');
            }

            // =========================================================================
            // FORM SUBMIT VALIDATION DENGAN SWEETALERT & SCROLL TO FIRST ERROR
            // =========================================================================
            $('#suratPermohonanPenetapanDiversiFormSubmit').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    // Aktifkan kembali field yang didisable agar value tetap terkirim saat post form
