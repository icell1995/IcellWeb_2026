...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah Surat Perintah Tugas (SPRINGAS)</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.surat-perintah-tugas-document.store', ['accident_id' => $accidentId]) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input type="hidden" class="form-control" id="relatedDocumentCode" name="relatedDocumentCode">
                    ...
                    <div class="col-sm-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isFinished" name="isFinished"
                                ...
                                @if (old('isFinished') == 1) {{ 'checked' }} @endif>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <textarea id="task" class="form-control noEnterTextArea @error('task') is-invalid @enderror font-weight-bold"
                            name="task" rows="5">{{ old('task') }}</textarea>
    ...
    <script type="text/javascript">
                ...
                if (relatedDocumentId !== '') {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var relatedDocumentLeaderOfficerRegisterNumber =
                                relatedDocumentLeaderOfficer.register_number || '';
                            var relatedDocumentLeaderOfficerFirstName =
                                relatedDocumentLeaderOfficer.first_name || '';
                            var relatedDocumentLeaderOfficerLastName =
                                relatedDocumentLeaderOfficer.last_name || '';
                            var relatedDocumentLeaderOfficerPhone = relatedDocumentLeaderOfficer
                                .phone_number || '';
                            var relatedDocumentLeaderOfficerRank = relatedDocumentLeaderOfficer
                                .rank;
                            var relatedDocumentLeaderOfficerRankId =
                                relatedDocumentLeaderOfficerRank.id || '';
                            var relatedDocumentLeaderOfficerRankName =
                                relatedDocumentLeaderOfficerRank.name || '';
                            var relatedDocumentLeaderOfficerPosition =
                                relatedDocumentLeaderOfficer.position;
                            var relatedDocumentLeaderOfficerPositionId =
                                relatedDocumentLeaderOfficerPosition.id || '';
                            var relatedDocumentLeaderOfficerPositionName =
                                relatedDocumentLeaderOfficerPosition.name || '';

                            var relatedDocumentLeaderOfficerPolice =
                                relatedDocumentLeaderOfficer.police ?? null;
                            ...
                            if (relatedDocumentLeaderOfficerPolice) {
                                if (relatedDocumentLeaderOfficerPolice.class == 'RESOR') {
                                    var relatedDocumentLeaderOfficerResortPolice =
                                        relatedDocumentLeaderOfficerPolice;
                                    var relatedDocumentLeaderOfficerResortPoliceId =
                                        relatedDocumentLeaderOfficerResortPolice.id;
                                    var relatedDocumentLeaderOfficerResortPoliceName =
                                        relatedDocumentLeaderOfficerResortPolice.full_name;

                                    var relatedDocumentLeaderOfficerRegionalPolice =
                                        relatedDocumentLeaderOfficerPolice.parent;
                                    var relatedDocumentLeaderOfficerRegionalPoliceId =
                                        relatedDocumentLeaderOfficerRegionalPolice.id;
                                    var relatedDocumentLeaderOfficerRegionalPoliceName =
                                        relatedDocumentLeaderOfficerRegionalPolice.full_name;

                                    var relatedDocumentLeaderOfficerPoliceName =
                                        relatedDocumentLeaderOfficerResortPoliceName + ' - ' +
                                        relatedDocumentLeaderOfficerRegionalPoliceName;
                                } else if (relatedDocumentLeaderOfficerPolice.class ==
                                    'DAERAH') {
                                    var relatedDocumentLeaderOfficerResortPolice = '';
                                    var relatedDocumentLeaderOfficerResortPoliceId = '';
                                    var relatedDocumentLeaderOfficerResortPoliceName = '';
                            ...
                            $('#officerLeader').append($('<option>', {
                                ...
                                text: relatedDocumentLeaderOfficerRegisterNumber +
                                    ' - ' + relatedDocumentLeaderOfficerFirstName +
                                    ' ' + relatedDocumentLeaderOfficerLastName +
                                    ' | ' +
                                    relatedDocumentLeaderOfficerPositionName,
                                selected: true,
                                'data-register-number': relatedDocumentLeaderOfficerRegisterNumber,
                            }));

                            // append value to hiiden input
                            $('#officerLeaderRegisterNumber').val(
                                relatedDocumentLeaderOfficerRegisterNumber);
                            $('#officerLeaderFirstName').val(
                                relatedDocumentLeaderOfficerFirstName);
                            $('#officerLeaderLastName').val(
                                relatedDocumentLeaderOfficerLastName);
                            $('#officerLeaderPhone').val(relatedDocumentLeaderOfficerPhone);
                            $('#officerLeaderRankId').val(relatedDocumentLeaderOfficerRankId);
                            $('#officerLeaderRankName').val(
                                relatedDocumentLeaderOfficerRankName);
                            $('#officerLeaderPositionId').val(
                                relatedDocumentLeaderOfficerPositionId);
                            $('#officerLeaderPositionName').val(
                                relatedDocumentLeaderOfficerPositionName);
                            $('#officerLeaderRegionalPoliceId').val(
                                relatedDocumentLeaderOfficerRegionalPoliceId);
                            $('#officerLeaderRegionalPoliceName').val(
                                relatedDocumentLeaderOfficerRegionalPoliceName);
                            $('#officerLeaderResortPoliceId').val(
                                relatedDocumentLeaderOfficerResortPoliceId);
                            $('#officerLeaderResortPoliceName').val(
                                relatedDocumentLeaderOfficerResortPoliceName);

                            // Langsung muat dropdown anggota berdasarkan ketua yang baru dipilih
        ...
        $(document).ready(function() {
            $('#officerMemberOptionAddButtton').on('click', function() {
                ...
                var signatoryRegisterNumber = $('#signatory').find('option:selected').data(
                    'register-number');
                var leaderOfficerRegisterNumber = $('#officerLeader').find('option:selected').data(
                    'register-number');
                ...
                if (!isAppended) {
                    ...
                    newRow.append('<td><input type="hidden" name="officers[]" value="' + registerNumber +
                        '"><button class="btn btn-danger btn-sm deleteOfficer" type="button"><i class="bi bi-trash"></i></button></td>'
                    );
