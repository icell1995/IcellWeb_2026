        ...
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center">
                    ...
                    <h4 class="pt-1 pb-2 font-weight-bolder">NOMOR : {{$suratPerintahTugasDocument->document_number}}</h4>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                Bahwa untuk kepentingan penyelidikan tindak pidana, maka perlu mengeluarkan surat perintah ini.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                1. Pasal 5 ayat (2), Pasal 7 ayat (1) huruf d, Pasal 8, Pasal 9, Pasal 11, Pasal 12, Pasal 16, Pasal 18 ayat (1), Pasal 19 ayat (2), Pasal 106, Pasal 109 ayat (1) dan Pasal 110 ayat (1) KUHAP <br/>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                @php $xNo = 1; @endphp 
                                @foreach($suratPerintahTugasDocument->suratPerintahTugasDocumentOfficers->where('class','=','MEMBER') as $officer)
                                    {{$xNo}}. Nama : {{$officer->first_title . ' ' . $officer->first_name . ' ' . $officer->last_name . ', ' . $officer->last_title}} <br/>
                                    Pangkat/NRP : {{$officer->rank->name ?? '' . '/' . $officer->register_number}} <br/>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                1. Melaksanakan penyidikan terhadap dugaan terjadinya tindak pidana kecelakaan lalu lintas yang terjadi pada Hari {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('l')}} Tanggal {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('d F Y')}} sekira pukul {{Carbon\Carbon::parse($accident->accident_time)->locale('id')->translatedFormat('H:i')}} di {{$accident->road_name}} <br/>
                                2. Mengadakan koordinasi dan kerja sama yang sebaik-baiknya dengan Kepolisian setempat dan instansi terkait. <br/>
                                3. Melaporkan setiap perkembangan pelaksanaan penyelidik tindak pidana tersebut kepada {{$suratPerintahTugasDocument->suratPerintahTugasDocumentOfficers->where('class', 'SIGNATORY')->first()->position->name ?? ''}} selaku Penyidik <br/>
                ...
                <button type="button" class="btn btn-primary btn-lg float-right mr-4">
                    <a href="{{route('doc.surat-perintah-tugas-document.download', ['id'=> $suratPerintahTugasDocumentId,'accident_id' => $accident->id])}}" style="color: #ffffff"><i class="fa fa-download"></i> Download</a>
                </button>
