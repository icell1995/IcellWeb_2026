...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            <form method="POST" action="{{ route('doc.perpanjangan-lanjutan-document.update', ['id' => $doc->id, 'accident_id' => $accidentId, 'document_category_id' => '0604']) }}">
                @csrf
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input class="form-control s22-date @error('documentDate') is-invalid @enderror" id="documentDate"
                            ...
                            value="{{ old('documentDate', $doc->document_date ?? '') }}" data-provide="datepicker" required readonly>
                        @error('documentDate')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $ref = $p['references'] ?? [];
                            $sprindikSelected = old('suratPerintahPenyidikanDocument', $ref['sprindik_document_id'] ?? null);
                        @endphp
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $sphSelected = old('suratPerintahPenahanan', $ref['sph_id'] ?? null);
                        @endphp
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6"><input type="text" class="form-control" name="releaseOrderNumber" value="{{ old('releaseOrderNumber', $orders['release_order_number'] ?? '') }}" placeholder="Nomor"></div>
                            <div class="col-md-6"><input type="text" class="form-control s22-date" name="releaseOrderDate" value="{{ old('releaseOrderDate', $orders['release_order_date'] ?? '') }}" placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6"><input type="text" class="form-control" name="hospitalizationOrderNumber" value="{{ old('hospitalizationOrderNumber', $orders['hospitalization_order_number'] ?? '') }}" placeholder="Nomor"></div>
                            <div class="col-md-6"><input type="text" class="form-control s22-date" name="hospitalizationOrderDate" value="{{ old('hospitalizationOrderDate', $orders['hospitalization_order_date'] ?? '') }}" placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6"><input type="text" class="form-control" name="revokeHospitalizationOrderNumber" value="{{ old('revokeHospitalizationOrderNumber', $orders['revoke_hospitalization_order_number'] ?? '') }}" placeholder="Nomor"></div>
                            <div class="col-md-6"><input type="text" class="form-control s22-date" name="revokeHospitalizationOrderDate" value="{{ old('revokeHospitalizationOrderDate', $orders['revoke_hospitalization_order_date'] ?? '') }}" placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6"><input type="text" class="form-control" name="transferDetentionPlaceOrderNumber" value="{{ old('transferDetentionPlaceOrderNumber', $orders['transfer_detention_place_order_number'] ?? '') }}" placeholder="Nomor"></div>
                            <div class="col-md-6"><input type="text" class="form-control s22-date" name="transferDetentionPlaceOrderDate" value="{{ old('transferDetentionPlaceOrderDate', $orders['transfer_detention_place_order_date'] ?? '') }}" placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6"><input type="text" class="form-control" name="transferDetentionTypeOrderNumber" value="{{ old('transferDetentionTypeOrderNumber', $orders['transfer_detention_type_order_number'] ?? '') }}" placeholder="Nomor"></div>
                            <div class="col-md-6"><input type="text" class="form-control s22-date" name="transferDetentionTypeOrderDate" value="{{ old('transferDetentionTypeOrderDate', $orders['transfer_detention_type_order_date'] ?? '') }}" placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex-align-self-center">
                        <select class="form-control select2 @error('suspect') is-invalid @enderror" name="suspect" id="suspect" required>
                            ...
                            @foreach ($suspects as $s)
                                <option value="{{ $s->id }}" {{ old('suspect', $doc->suspect_id) == $s->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $sig = $p['signature'] ?? [];
                            $sigSelected = old('signatoryOfficerId', $sig['officer_id'] ?? null);
                        @endphp
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $sub = $p['submitted'] ?? [];
                            $subSelected = old('submittedOfficerId', $sub['officer_id'] ?? null);
                        @endphp
                ...
                @php
                    $alasanVal = old('alasan', $p['alasan'] ?? null);
                    $alasanSelected = $alasanVal;
                    $penempatan = $p['penempatan'] ?? [];
                    $penempatanTypeOld = old('penempatan_type', $penempatan['type'] ?? '');
                    $penempatanOld = old('penempatan_detail', $penempatan['detail'] ?? '');
                    $rutanSelected = old('penempatan_rutan_id', $penempatan['prison_id'] ?? null);
                ...
                <input type="hidden" name="penempatan_type" id="s22_penempatan_type" value="{{ old('penempatan_type', $penempatan['type'] ?? '') }}">
                <input type="hidden" name="penempatan_detail" id="s22_penempatan_detail" value="{{ old('penempatan_detail', $penempatan['detail'] ?? '') }}">
                <input type="hidden" name="penempatan_rutan_id" id="s22_penempatan_rutan_id" value="{{ old('penempatan_rutan_id', $penempatan['prison_id'] ?? '') }}">
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        ...
                        <input type="text" class="form-control s22-date" name="handoverDate" id="handoverDate"
                            value="{{ old('handoverDate', $handover['date'] ?? '') }}"
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var suspectAddresses = {!! json_encode($suspectAddresses ?? []) !!};
            var suspectRegencies = {!! json_encode($suspectRegencies ?? []) !!};
            var s22CabangPrefill = {!! json_encode($cabangOld ?? '') !!};
