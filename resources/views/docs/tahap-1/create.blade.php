@php
    $_title = 'Surat Pengiriman Berkas Perkara (Tahap I)';
@endphp
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah Surat Pengiriman Berkas Perkara (Tahap I)</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.tahap-1-document.store', ['accident_id' => $accidentId]) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                        <input id="surat_perintah_penahanan_number" type="text" class="form-control" name="surat_perintah_penahanan_number" value="{{ old('surat_perintah_penahanan_number') }}">
                    </div>
                </div>
