@php
    $_title = 'Edit Surat Perintah Penyidikan';
@endphp
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Edit Surat Perintah Penyidikan (SPRINSIDIK)</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.surat-perintah-penyidikan-document.update', ['accident_id' => $accidentId, 'id'=> $suratPerintahPenyidikanDocumentId]) }}"
                    ...
                    <form id="addLawForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="constitutionChapterLawForm" name="constitutionChapterLawForm">
                                ...
                                {{-- <option value="Pasal 273 Ayat (1)">Pasal 273 Ayat (1) [Kecelakaan Karena Jalan Rusak]</option>
                                <option value="Pasal 273 Ayat (2)">Pasal 273 Ayat (2) [Kecelakaan Karena Jalan Rusak]</option>
                                <option value="Pasal 273 Ayat (3)">Pasal 273 Ayat (3) [Kecelakaan Karena Jalan Rusak]</option>
                                <option value="Pasal 273 Ayat (4)">Pasal 273 Ayat (4) [Kecelakaan Karena Jalan Rusak]</option>
                                <option value="Pasal 275 Ayat (1)">Pasal 275 Ayat (1)</option>
                                <option value="Pasal 275 Ayat (2)">Pasal 275 Ayat (2) [Merusak Rambu-Rambu Dan Fasilitas Jalan]</option>
                                <option value="Pasal 277">Pasal 277 [Kecelakaan Karena Overdimensi Dan Overload]</option>
                                <option value="Pasal 310 Ayat (1)">Pasal 310 Ayat (1) [Kecelakaan Karena Lalai]</option>
                                <option value="Pasal 310 Ayat (2)">Pasal 310 Ayat (2) [Kecelakaan Karena Lalai]</option>
                                <option value="Pasal 310 Ayat (3)">Pasal 310 Ayat (3) [Kecelakaan Karena Lalai]</option>
                                <option value="Pasal 310 Ayat (4)">Pasal 310 Ayat (4) [Kecelakaan Karena Lalai]</option>
                                <option value="Pasal 311 Ayat (1)">Pasal 311 Ayat (1) [Kesengajaan Yang Mengakibatkan Kecelakaan]</option>
                                <option value="Pasal 311 Ayat (2)">Pasal 311 Ayat (2) [Kesengajaan Yang Mengakibatkan Kecelakaan]</option> 
                                <option value="Pasal 311 Ayat (3)">Pasal 311 Ayat (3) [Kesengajaan Yang Mengakibatkan Kecelakaan]</option>
                                <option value="Pasal 311 Ayat (4)">Pasal 311 Ayat (4) [Kesengajaan Yang Mengakibatkan Kecelakaan]</option>
                                <option value="Pasal 311 Ayat (5)">Pasal 311 Ayat (5) [Kesengajaan Yang Mengakibatkan Kecelakaan]</option>
                                <option value="Pasal 312">Pasal 312 [Tabrak Lari / Kecelakaan Karena Tidak Melakukan Pertolongan]</option> --}}
                            </select>
                        </div>
                    </form>
                </div>
            ...
            $(function() {
                for (var key in mainLaws) {
                    if (mainLaws.hasOwnProperty(key)) {
                        ...
                        var constitutionChapter = (mainLaw.constitution_chapter != null) ? mainLaw.constitution_chapter : '';
            ...
            $(function() {
                for (var key in additionalLaws) {
                    if (additionalLaws.hasOwnProperty(key)) {
                        ...
                        var additionalLawName = (additionalLaw.constitution != null) ? additionalLaw.constitution : '';
