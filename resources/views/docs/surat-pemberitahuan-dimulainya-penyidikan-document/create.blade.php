...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah Surat Pemberitahuan Dimulainya Penyidikan (SPDP)</h5>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2" name="suratPerintahTugasDocument" id="suratPerintahTugasDocument">
                            ...
                            @foreach ($suratPerintahTugasDocuments as $suratPerintahTugasDocument)
                                <option value="{{ $suratPerintahTugasDocument->id }}">
		...
		@endif
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-dark-blue"
                        id="suratPemberitahuanDimulainyaPenyidikanFormSubmit">
