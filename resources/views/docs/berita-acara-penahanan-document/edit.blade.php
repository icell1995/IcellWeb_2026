@php
    $_title = 'Edit Berita Acara Penahanan (BA-HAN)';
@endphp
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Edit Berita Acara Penahanan (BA-HAN)</h5>
        ...
        <div class="box-body">
            <form action="{{ route('doc.berita-acara-penahanan-document.update', ['accident_id' => $accidentId, 'id' => $beritaAcaraPenahananDocumentId]) }}"
                        ...
                        <select class="form-control select2 @error('suratPerintahPenahananDocument') is-invalid @enderror"
                            ...
                            @foreach ($suratPerintahPenahananDocuments as $doc)
                                <option value="{{ $doc->id }}"
                                    ...
                                    {{ old('suratPerintahPenahananDocument', $document->reference_document_id ?? '') == $doc->id ? 'selected' : '' }}>
                                    {{ $doc->document_number }}
                                </option>
                            @endforeach
                        </select>
                ...
                <input type="hidden" id="suratPerintahPenahananDate" name="suratPerintahPenahananDate"
                    value="{{ old('suratPerintahPenahananDate', $document->reference_document_date ?? '') }}">
                <input type="hidden" id="suratPerintahPenahananDocumentNumber" name="suratPerintahPenahananDocumentNumber"
                    value="{{ old('suratPerintahPenahananDocumentNumber', $document->reference_document_number ?? '') }}">
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control @error('time') is-invalid @enderror" id="time" name="time"
                            placeholder="hh:mm" autocomplete="off" value="{{ old('time', $document->time ?? '') }}" required>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                        <select class="form-control select2 @error('timezone') is-invalid @enderror" name="timezone" id="timezone" required>
                            ...
                            @foreach ($timezones as $timezone)
                                <option value="{{ $timezone->id }}" {{ old('timezone', $document->timezone_id ?? '') == $timezone->id ? 'selected' : '' }}>{{ $timezone->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input class="form-control @error('place') is-invalid @enderror" id="place" name="place"
                            ...
                            value="{{ old('place', $document->place ?? '') }}" required>
                        ...
                        <select class="form-control select2" name="officerLeader" id="officerLeader">
                            ...
                            @foreach ($internalOfficers as $data)
                                ...
                                <option value="{{ $data->id }}" data-register-number="{{ $data->register_number }}"
                                    {{ old('officerLeader', $document->officer_leader_id ?? '') == $data->id ? 'selected' : '' }}>
                        ...
                        <div class="d-flex mb-2 @error('investigatorRole') border border-danger p-2 rounded is-invalid @enderror" id="investigatorRoleWrapper">
                            <div class="form-check me-3">
                                <input class="form-check-input @error('investigatorRole') is-invalid @enderror" type="radio" id="rolePenyidik" name="investigatorRole"
                                    value="Penyidik" {{ old('investigatorRole', $document->investigator_role ?? '') == 'Penyidik' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('investigatorRole') is-invalid @enderror" type="radio" id="rolePenyidikPembantu" name="investigatorRole"
                                    value="Penyidik Pembantu" {{ old('investigatorRole', $document->investigator_role ?? '') == 'Penyidik Pembantu' ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2 @error('suspect') is-invalid @enderror" name="suspect" id="suspect" required>
                            ...
                            @foreach ($suspects as $suspectItem)
                                <option value="{{ $suspectItem->id }}" {{ old('suspect', $document->suspect_id ?? '') == $suspectItem->id ? 'selected' : '' }}>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input id="detentionPlace" type="text"
                            ...
                            name="detentionPlace" value="{{ old('detentionPlace', $document->detention_place ?? ('Rumah Tahanan Negara ' . ($police->name ?? ''))) }}" required
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input id="detentionBranch" type="text"
                            ...
                            name="detentionBranch" value="{{ old('detentionBranch', $document->detention_branch ?? ($police->name ?? '')) }}" required
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control" id="startDate" name="startDate" placeholder="YYYY-MM-DD"
                            autocomplete="off" value="{{ old('startDate', $document->start_date ?? date('Y-m-d')) }}" readonly>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control" id="endDate" name="endDate" placeholder="YYYY-MM-DD"
                            autocomplete="off" value="{{ old('endDate', $document->end_date ?? date('Y-m-d', strtotime('+19 days'))) }}" readonly>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <textarea id="task" class="form-control @error('task') is-invalid @enderror font-weight-bold" name="task" rows="3"
                            placeholder="Adapun pelaksanaannya sebagai berikut: [...tambahkan untuk isi bagian ini...]" required>{{ old('task', $document->task ?? '') }}</textarea>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <textarea id="healthCondition" class="form-control @error('healthCondition') is-invalid @enderror font-weight-bold"
                            ...
                            placeholder="Keadaan kesehatan/fisik tersangka sebelum dimasukkan ke dalam ruang tahanan [...tambahkan untuk isi bagian ini...] dalam keadaan sehat.">{{ old('healthCondition', $document->health_condition ?? '') }}</textarea>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <input class="form-control @error('documentDate') is-invalid @enderror" id="documentDate"
                            ...
                            value="{{ old('documentDate', $document->document_date ?? '') }}" data-provide="datepicker"
...
@endif
    ...
    <script>
        $(document).ready(function() {
            ...
            // ==========================================
            // PRELOAD EXISTING COMPANION OFFICERS
            // ==========================================
            var existingCompanionOfficers = @json($existingCompanionOfficers ?? []);
            if (existingCompanionOfficers && existingCompanionOfficers.length > 0) {
                existingCompanionOfficers.forEach(function(officer) {
                    var registerNumber = officer.register_number;
                    var rankName = (officer.rank) ? officer.rank.name : (officer.rank_name || '-');
                    var name = ((officer.first_title) ? officer.first_title + ' ' : '') + officer.first_name + ((officer.last_name) ? ' ' + officer.last_name : '') + ((officer.last_title) ? ', ' + officer.last_title : (officer.full_name || ''));
                    var positionName = (officer.position) ? officer.position.name : (officer.position_name || '-');
                    var policeName = (officer.police) ? officer.police.full_name : (officer.police_name || '-');
            ...
            // ==========================================
            function loadInternalOfficersForLeader(selectedLeader) {
            ...
            // Inisialisasi daftar dropdown penyidik pendamping jika Penyidik Pembuat BA sudah terpilih sebelumnya
            var currentLeader = $('#officerLeader').find('option:selected').data('register-number');
            if (currentLeader) {
                loadInternalOfficersForLeader(currentLeader);
            } else {
                $('#officerInternalMemberOption').prop('disabled', true);
            }
            ...
            $('#officerLeader').on('change', function() {
                ...
                if (!isAppended) {
                    loadInternalOfficersForLeader(selectedLeader);
                }
            });
