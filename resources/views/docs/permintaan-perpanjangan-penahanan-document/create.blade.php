...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            <form action="{{ route('doc.permintaan-perpanjangan-penahanan-document.store', ['accident_id' => $accidentId]) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input class="form-control s21-date @error('documentDate') is-invalid @enderror" id="documentDate"
                            ...
                            value="{{ old('documentDate') }}" data-provide="datepicker" required>
                        @error('documentDate')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2 @error('court') is-invalid @enderror" name="court" id="court" required>
                            ...
                            @foreach($courts as $court)
                                <option value="{{ $court->id }}" {{ old('court') == $court->id ? 'selected' : '' }}>
                                    {{ $court->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $kejSelected = old('kejaksaanProsecutorId');
                        @endphp
                        ...
                        <input type="hidden" name="namaKejaksaan" value="{{ old('namaKejaksaan', '') }}">
                    </div>
                </div>

                @php
                    $spdpNumberDb = $spdpDef['number'] ?? null;
                    $spdpDateDb = $spdpDef['date'] ?? null;
                    ...
                    $spdpSel = old('suratPemberitahuanDimulainyaPenyidikanDocument');
                @endphp
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        ...
                        {{-- fallback jika belum ada SPDP di database --}}
                        ...
                        @else
                            {{-- jika dropdown dipilih, backend ambil dari DB; hidden ini menjaga payload konsisten untuk dokumen lama --}}
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        @php
                            $sketSel = old('suratKetetapanTentangPenetapanTersangkaDocument');
                        @endphp
                        <select class="form-control select2" name="suratKetetapanTentangPenetapanTersangkaDocument" id="suratKetetapanTentangPenetapanTersangkaDocument" required>
                            ...
                            @foreach ($suratKetetapanTentangPenetapanTersangkaDocuments as $d)
                                <option value="{{ $d->id }}" {{ (string) $sketSel === (string) $d->id ? 'selected' : '' }}>
                                    {{ $d->document_number }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="kejaksaanExtensionNumber" value="{{ old('kejaksaanExtensionNumber') }}" placeholder="Nomor">
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control s21-date" name="kejaksaanExtensionDate" value="{{ old('kejaksaanExtensionDate') }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="perpanjanganOrderNumber" value="{{ old('perpanjanganOrderNumber') }}" placeholder="Nomor">
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control s21-date" name="perpanjanganOrderDate" value="{{ old('perpanjanganOrderDate') }}"
                                    placeholder="Tanggal (YYYY-MM-DD)" autocomplete="off" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <input type="text" name="detentionEndDate" id="detentionEndDate"
                            ...
                            value="{{ old('detentionEndDate') }}" placeholder="YYYY-MM-DD" autocomplete="off" readonly required>
                ...
                <div class="input-group row mb-3 ms-0">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                        <select class="form-control select2" name="extension_prison_id" id="extension_prison_id">
                            ...
                            @foreach (($prisons ?? collect()) as $p)
                                <option value="{{ $p->id }}" {{ old('extension_prison_id') == $p->id ? 'selected' : '' }}>
                                    {{ $p->province }} — {{ $p->name }}{{ $p->branch ? ' ('.$p->branch.')' : '' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                                ...
                                <select class="form-control select2" name="contactOfficerId" id="contactOfficerId">
                                    ...
                                    @foreach (($contactOfficers ?? collect()) as $o)
                                        <option value="{{ $o->id }}"
                                            ...
                                            {{ old('contactOfficerId') == $o->id ? 'selected' : '' }}>
                                    @php
...
@push('script')
    ...
    @php
        $initialCarbonCopies = old('carbonCopies') ?? [];
    @endphp
    <script>
