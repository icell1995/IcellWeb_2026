        ...
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center">
                    ...
                    <h4 class="pt-1 pb-2 font-weight-bolder">NOMOR : {{$suratPerintahPenyelidikanDocument->document_number}}</h4>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                @php $xNo = 1; @endphp 
                                @foreach($suratPerintahPenyelidikanDocument->suratPerintahPenyelidikanDocumentOfficers->where('class','!=','SIGNATORY') as $officer)
                                    @php
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <div class="card">
                            <div class="card-body">
                                1. Melakukan penyelidikan tindak pidana kasus kecelakaan lalu lintas yang terjadi pada Hari {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('l')}} Tanggal {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('d F Y')}} sekira pukul {{Carbon\Carbon::parse($accident->accident_time)->locale('id')->translatedFormat('H:i')}} di {{$accident->road_name}} <br/>
                                2. Membuat rencana penyelidikan <br/>
                                3. Melaporkan setiap perkembangan pelaksanaan penyelidik tindak pidana tersebut kepada {{$suratPerintahPenyelidikanDocument->suratPerintahPenyelidikanDocumentOfficers->where('class', 'SIGNATORY')->first()->position->name ?? ''}} selaku Penyelidik <br/>
                ...
                <button type="button" class="btn btn-primary btn-lg float-right mr-4">
                    <a href="{{route('doc.surat-perintah-penyelidikan-document.download', ['id'=> $suratPerintahPenyelidikanDocumentId,'accident_id' => $accident->id])}}" style="color: #ffffff"><i class="fa fa-download"></i> Download</a>
                </button>
