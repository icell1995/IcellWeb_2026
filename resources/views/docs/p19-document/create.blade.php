...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah P21</h5>
        ...
        <div class="box-body">
            <form
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-2 col-form-label" for="reportDate">Tanggal LP</label>
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input id="reportDate" type="text"
                            class="form-control @error('reportDate') is-invalid @enderror font-weight-bold"
                            name="reportDate" value="{{-- $accident->no_lp --}}" required placeholder="" readonly>
                        @error('reportDate')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-2 col-form-label" for="tahap1DocumentNumber">No Tahap I<span class="text-danger fs-5">*</span></label>
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex-align-self-center">
                        <select class="form-control select2" name="tahap1DocumentNumber" id="tahap1DocumentNumber">
                            <option value="">--Pilih No Tahap I--</option>
                        </select>

                        @error('tahap1DocumentNumber')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
