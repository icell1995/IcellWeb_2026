...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h5 class="fw-bold text-blue-dark">Tambah Tahap I</h5>
        ...
        <div class="box-body">
            <form
                action="{{ route('doc.tahap-1-document.store', ['accident_id' => $accidentId]) }}"
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-2 col-form-label" for="fillingNumber">Nomor Pemberkasan<span class="text-danger fs-5">*</span></label>
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input id="fillingNumber" type="text"
                            class="form-control @error('fillingNumber') is-invalid @enderror font-weight-bold"
                            name="fillingNumber" value="{{ old('fillingNumber') }}" required
                            placeholder="Masukkan Nomor Pemberkasan">
                ...
                <div class="input-group row mb-3 ms-0">
                    <label class="fw-bold col-sm-2 col-form-label">Tanggal Pemberkasan<span class="text-danger fs-5">*</span></label>
                    <div class="col-lg-10 col-md-10 col-sm-12 col-12 d-flex align-self-center">
                        <input class="form-control" id="fillingDate" name="fillingDate"
                            placeholder="YYYY-MM-DD" autocomplete="off" value="{{ old('fillingDate') }}"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#tahap1FormSubmit').on('click', function(e) {
                ...
                $.ajax({
                    url: "{{ route('doc.tahap-1-document.api.validate-request-form', ['accident_id' => $accidentId]) }}",
                    type: 'POST',
                    dataType: 'json',
