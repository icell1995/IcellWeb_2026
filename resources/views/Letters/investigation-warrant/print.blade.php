    ...
    <div class="d-flex justify-content-center" style="background-color: #eeeeee">
        <div class="radius-card mt-4 w-60">
            <form target="_blank" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <span class="">RESOR {{$accident->polres->name ?? ''}}</span>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center">
                    <h3><span class="pb-1 border-bot  font-weight-bolder">SURAT PERINTAH PENYELIDIKAN</span></h3>
                    <h4 class="pt-1 pb-2 font-weight-bolder">NOMOR : {{$investigationWarrant->letter_number}}</h4>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea"
                            name="" disabled>Bahwa untuk kepentingan penyelidikan tindak pidana, maka perlu mengeluarkan surat perintah ini.</textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name=""
                            disabled>1. Pasal 7, Pasal 8, Pasal 9, Passal 11, Pasal 12, Pasal 159, Pasal 106, Pasal 109 ayat (1), Pasal 10 ayat (1) KUHAP&#13;&#10;2. Undang-Undang Republik Indonesia Nomor 2 Tahun 2002 tentang Kepolisian Negara Republik Indonesia&#13;&#10;3. Udang-Undang Republik Indonesia Nomor 22 Tahun 2009 tentang Lalu Lintas dan Angkutan Jalan&#13;&#10;4. Laporan Polisi Nomor : {{$accident->no_lp}}, tanggal {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('d F Y')}}</textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea" name="" id="" disabled>@php $xNo = 1; @endphp @foreach($investigationWarrant->leaderOfficers as $officer){{$xNo}}. Nama : {{$officer->first_name . ' ' . $officer->last_name}}&#13;&#10;Pangkat/NRP : {{$officer->rank_id . '/' . $officer->id}}&#13;&#10;Jabatan : {{$officer->position_short_name}}&#13;&#10;@php $xNo++; @endphp @endforeach @foreach($investigationWarrant->officers as $officer){{$xNo}}. Nama : {{$officer->first_name . ' ' . $officer->last_name}}&#13;&#10;Pangkat/NRP : {{$officer->rank_id . '/' . $officer->id}}&#13;&#10;Jabatan : {{$officer->position_short_name}}&#13;&#10;@php $xNo++; @endphp @endforeach</textarea>
                    </div>
                </div>
                ...
                <div class="row col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-9 p-0">
                        <textarea class="form-control inline-block txtarea"
                            name="" disabled>1. Melakukan penyelidikan tindak pidana kasus kecelakaan lalu lintas yang terjadi pada Hari {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('l')}} Tanggal {{Carbon\Carbon::parse($accident->accident_date)->locale('id')->translatedFormat('d F Y')}} sekira pukul {{Carbon\Carbon::parse($accident->accident_time)->locale('id')->translatedFormat('H:i')}} di {{$accident->road_name}}&#13;&#10;2. Membuat rencana penyelidikan&#13;&#10;3. Melaporkan setiap perkembangan pelaksanaan penyelidik tindak pidana tersebut kepada {{$investigationWarrant->authorizedSignatories->first()->position_id}} selaku Penyelidik&#13;&#10;4. Surat Perintah ini berlaku sejak tanggal dikeluarkan</textarea>
                    </div>
                </div>

                <button type="button" class="btn btn-primary float-right mr-4">
                    <a href="{{route('investigation-warrant.print', ['id'=> $investigationWarrantId,'accident_id' => $accident->id])}}" style="color: #ffffff">Generate</a>
                </button>
