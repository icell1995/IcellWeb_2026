@php
    $_title = 'Surat Perintah Penyelidikan';
@endphp
@extends('layouts.app')
...
<div class="content col-xs-12 col-md-12 col-lg-12 col-sm-12">
    ...
    <div class="box">
        ...
        <form action="{{ route('investigation-warrant.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group" style="padding: 0px">
                            <input id="letter_number" type="text"
                                ...
                                value="{{ old('letter_number') }}" required placeholder="Masukkan Nomor Surat Sprinlidik">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group" style="padding: 0px">
                            <input class="form-control datepicker" id="end_date" name="end_date"
                                placeholder="DD/MM/YYYY" autocomplete="off" value="@if(old('is_finished') != 1){{old('end_date')}}@endif" data-provide="datepicker" @if(old('is_finished') == 1){{'readonly'}}@endif>
                            <div class="form-check ml-2">
                                <input class="form-check-input" type="checkbox" id="is_finished" name="is_finished" value="1" @if(old('is_finished') == 1){{'checked'}}@endif>
