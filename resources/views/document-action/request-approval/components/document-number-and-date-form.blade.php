<form
    ...
    <div class="input-group row mb-3 ms-0">
        <label class="fw-bold col-sm-3 col-form-label" for="documentNumber">Nomor Dokumen : </label>
        <div class="col-lg-9 col-md-9 col-sm-12 col-12">
            <input id="documentNumber" type="text"
                class="form-control @error('documentNumber') is-invalid @enderror font-weight-bold"
                name="documentNumber" value="{{ $document->document_number }}" required placeholder="No Dokumen">
    ...
    <div class="input-group row mb-3 ms-0">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-12">
            <input class="form-control datepicker" id="documentDate" name="documentDate" placeholder="YYYY-MM-DD"
