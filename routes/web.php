    ...
    Route::group(['middleware' => ['is-evaluation-form-filled', 'is-signatory']], function () {
        ...
        Route::group(['middleware' => 'can:role.R'], function () {
            ...
            Route::prefix('role-new')->group(function () {
                ...
                Route::post('/delete/{id}', [App\Http\Controllers\RoleNewController::class, 'destroy'])->name('role-new-delete');
            });
        });
        ...
        */
        ...
        Route::middleware('can:statistics.R')->group(function () {
            Route::prefix('statistika')->group(function () {
                ...
                Route::middleware('can:statistics.E')->group(function () {
        ...
        Route::middleware('can:anev.R')->group(function () {
        ...
        */
        ...
        Route::middleware('can:carousel.R')->group(function () {
        ...
        */
        ...
        Route::middleware('can:commander-wish.R')->group(function () {
            Route::prefix('/commander-wish')->group(function(){
                ...
                Route::middleware('can:commander-wish.E')->group(function () {
        ...
        Route::middleware('can:personnel.R')->group(function () {
        ...
        Route::middleware('can:document-action.R')->group(function () {
        ...
        Route::middleware('can:document-signature.R')->group(function () {
        ...
        Route::middleware('can:document-signature-verif.R')->group(function () {
            Route::prefix('document-signature/verification')->group(function (){
        ...
        Route::middleware('can:document-approval.R')->group(function () {
        ...
        Route::middleware('can:document-approval-upload.R')->group(function () {
            Route::prefix('document-approval/upload')->group(function (){
