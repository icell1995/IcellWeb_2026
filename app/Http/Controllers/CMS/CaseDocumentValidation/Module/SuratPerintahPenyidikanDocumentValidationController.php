...
class SuratPerintahPenyidikanDocumentValidationController extends Controller
{
    ...
    public function approveValidation(Request $request, $id)
    {
        ...
        try{
            ...
            return redirect()->route('cms.case-document-validation.index')->with('success', 'Surat Perintah Penyidikan berhasil disetujui.');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function rejectValidation(Request $request, $id)
    {
        ...
        if($isRejectedBoolean == true) {
            ...
            try{
                ...
                return redirect()->route('cms.case-document-validation.index')->with('success', 'Surat Perintah Penyidikan berhasil dikembalikan.');
            } catch (\Exception $e) {
                DB::rollback();
