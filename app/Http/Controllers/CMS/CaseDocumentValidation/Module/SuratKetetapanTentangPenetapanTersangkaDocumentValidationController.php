        ...
        try{
            ...
            if ($request->ajax() || $request->expectsJson()) {
                return response()->json([
                    'success' => true,
                    'message' => 'Surat Ketetapan Tentang Penetapan Tersangka berhasil disetujui.'
                ]);
            }
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Surat Ketetapan Tentang Penetapan Tersangka berhasil disetujui.',
    ...
    public function rejectValidation(Request $request, $id)
    {
        ...
        if($isRejectedBoolean == true) {
            ...
            if ($request->ajax() || $request->expectsJson()) {
                return response()->json([
                    'success' => true,
                    'message' => 'Surat Ketetapan Tentang Penetapan Tersangka berhasil dikembalikan.'
                ]);
            }
                ...
                <body>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Surat Ketetapan Tentang Penetapan Tersangka berhasil dikembalikan.',
                            showConfirmButton: false,
                            timer: 1500,
                            timerProgressBar: true,
                            allowOutsideClick: false,
