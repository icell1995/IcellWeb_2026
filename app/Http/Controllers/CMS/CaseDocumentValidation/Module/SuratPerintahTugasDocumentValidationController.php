        ...
        try{
            ...
            if ($request->ajax() || $request->expectsJson()) {
                return response()->json([
                    'success' => true,
                    'message' => 'Surat Perintah Tugas berhasil disetujui.'
                ]);
            }
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Surat Perintah Tugas berhasil disetujui.',
    ...
    public function rejectValidation(Request $request, $id)
    {
        ...
        if($isRejectedBoolean == true) {
            ...
            if ($request->ajax() || $request->expectsJson()) {
                return response()->json([
                    'success' => true,
                    'message' => 'Surat Perintah Tugas berhasil dikembalikan.'
                ]);
            }
                ...
                <body>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Surat Perintah Tugas berhasil dikembalikan.',
                            showConfirmButton: false,
                            timer: 1500,
                            timerProgressBar: true,
                            allowOutsideClick: false,
