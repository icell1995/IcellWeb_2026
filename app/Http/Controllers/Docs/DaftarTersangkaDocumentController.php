...
class DaftarTersangkaDocumentController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('docs.daftar-tersangka-document.show', $viewData);
    }
    ...
    public function create()
    {
        ...
        return view('docs.daftar-tersangka-document.create', $viewData);
    }
    ...
    public function edit($id)
    {
        ...
        return view('docs.daftar-tersangka-document.edit', $viewData);
    }
