...
class ReportedPersonController extends Controller
{
    ...
    public function show($accidentId, $id)
    {
        ...
        $reportedPerson = ReportedPerson::find($id);
        ...
        return view('case.participant.reported-person.show', $viewData);
    }    
    ...
    {   
        ...
        return view('case.participant.reported-person.create', $viewData);
    }
    ...
    public function store(Request $request, $accidentId)
    {
        ...
        try{
            ...
            DB::rollBack();
            Log::error('ReportedPersonController : ', [$e->getMessage()]);
    ...
    public function edit($accidentId, $id)
    {
        ...
        return view('case.participant.reported-person.edit', $viewData);
    }
    ...
    public function update(Request $request, $accidentId, $id)
    {
        ...
        DB::beginTransaction();
        try{
            ReportedPerson::where('id', $id)->update([
                'accident_id' => $accidentId,
                'identity_type_id' => $identityType,
                'identity_number' => $identityNumber,
                'name' => $name,
