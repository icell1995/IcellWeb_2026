    ...
    public function getCekSP2HP(Request $request)
    {
        ...
        foreach ($allPenerima as $index => $penerima) {
            ...
            $penerimaList[] = [
                ...
                'jenis_identitas' => $penerima->identityType->name ?? null,
                ...
                'jenis_kelamin' => $penerima->gender->name ?? null,
                'nama_ayah' => $penerima->father_name,
                'nama_ibu' => $penerima->mother_name,
                'kewarganegaraan' => $penerima->nationality->name ?? null,
                'suku' => $penerima->ethnic->name ?? null,
                'agama' => $penerima->religion->name ?? null,
                'pendidikan' => $penerima->education->name ?? null,
                'pekerjaan' => $penerima->job->name ?? null,
                'status_perkawinan' => $penerima->maritalStatus->name ?? null,
        ...
        // --- ADDED: Fetch historical data from previous SP2HP types ---
        $historicalData = [
            'a4' => [],
            'a5' => [],
            'a6' => [],
        ...
        if ($sp2hp->accident_id) {
            ...
            foreach ($historyDocs as $doc) {
                ...
                if ($doc->tipe_sp2hp == 'A4' && empty($historicalData['a4'])) {
                    $historicalData['a4'] = $docTypeData;
                    ...
                    $historicalData['a5'] = $docTypeData;
                } elseif ($doc->tipe_sp2hp == 'A6' && empty($historicalData['a6'])) {
                    $historicalData['a6'] = $docTypeData;
                }
            }
        }
        // -----------------------------------------------------------
        ...
        $response = [
            ...
            'data' => [
                ...
                'tindakan_dilakukan' => $sp2hp->a4_tindakan_list ?? $historicalData['a4_tindakan_list'] ?? [],
                'a4_hambatan' => $typeSpecificData['a4_hambatan'] ?? $historicalData['a4']['a4_hambatan'] ?? null,
                'a4_rencana' => $typeSpecificData['a4_rencana'] ?? $historicalData['a4']['a4_rencana'] ?? null,
                
                // A5: Data Khusus (Penghentian Penyidikan / SP3) - from type_specific_data JSON
                'a5_sprin_sidik' => $typeSpecificData['a5_sprin_sidik'] ?? $historicalData['a5']['a5_sprin_sidik'] ?? null,
                'a5_sp2hp_terakhir' => $typeSpecificData['a5_sp2hp_terakhir'] ?? $historicalData['a5']['a5_sp2hp_terakhir'] ?? null,
                'a5_alasan_sp3' => $typeSpecificData['a5_alasan_sp3'] ?? $historicalData['a5']['a5_alasan_sp3'] ?? null,
                'a5_keterangan_sp3' => $typeSpecificData['a5_keterangan_sp3'] ?? $historicalData['a5']['a5_keterangan_sp3'] ?? null,
                
                // A6: Data Khusus (Pelimpahan Berkas Perkara Tahap 1) - from type_specific_data JSON
                'a6_sp2hp_terakhir' => $typeSpecificData['a6_sp2hp_terakhir'] ?? $historicalData['a6']['a6_sp2hp_terakhir'] ?? null,
                'a6_nama_tersangka' => $typeSpecificData['a6_nama_tersangka'] ?? $historicalData['a6']['a6_nama_tersangka'] ?? null,
                'a6_nomor_kirim_berkas' => $typeSpecificData['a6_nomor_kirim_berkas'] ?? $historicalData['a6']['a6_nomor_kirim_berkas'] ?? null,
                'a6_tanggal_kirim' => $typeSpecificData['a6_tanggal_kirim'] ?? $historicalData['a6']['a6_tanggal_kirim'] ?? null,
                'a6_tujuan_kejaksaan' => $typeSpecificData['a6_tujuan_kejaksaan_name'] 
                                        ?? $typeSpecificData['a6_tujuan_kejaksaan'] 
                                        ?? $historicalData['a6']['a6_tujuan_kejaksaan_name'] 
                                        ?? $historicalData['a6']['a6_tujuan_kejaksaan'] 
                                        ?? null,
                
                // A7: Data Khusus (Pelimpahan Berkas Perkara Tahap 2) - from type_specific_data JSON
                ...
                'a7_tujuan_kejaksaan' => $typeSpecificData['a7_tujuan_kejaksaan_name'] 
                ...
                'satuan_kerja' => [
                    'polres' => $sp2hp->accident->polres->name ?? null,
                    'polda' => $sp2hp->accident->polres->polda->name ?? null,
                ],
