...
class AssignmentOrderLetterController extends Controller
{
    public function index(Request $request){
        ...
        if (!empty($startDocumentDate) && !empty($endDocumentDate)) {
            $getData = $getData->whereBetween('TanggalSpringas', [date('Y-m-d H:i:s', strtotime($startDocumentDate)), date('Y-m-d H:i:s', strtotime($endDocumentDate))]);
        } else if (!empty($startDocumentDate)) {
            $getData = $getData->where('TanggalSpringas', '>=', date('Y-m-d H:i:s', strtotime($startDocumentDate)));
        } else if (!empty($endDocumentDate)) {
            $getData = $getData->where('TanggalSpringas', '<=', date('Y-m-d H:i:s', strtotime($endDocumentDate)));
        }
