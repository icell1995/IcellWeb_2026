...
class TutorialController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (!Auth::user()->hasPermission('tutorial.R')) {
            abort(403, 'Anda tidak memiliki hak akses ke halaman Tutorial.');
        }
        ...
        if ($search && $request->has('chat')) {
            ...
            $systemInstruction = "Nama Anda adalah BOT-ICELL, sistem robot asisten otomatis untuk sistem ICELL (Informasi Cepat Penyelidikan dan Penyidikan Laka Lantas). "
                . "Jawab pertanyaan pengguna secara kaku, lugas, sistematis, objektif, dan bagaikan robot sistem komputer HANYA berdasarkan data FAQ resmi yang disediakan di bawah ini. "
                . "PENTING: Jika jawaban atas pertanyaan tidak dapat ditemukan atau tidak didukung oleh data FAQ di bawah, Anda harus menjawab persis seperti ini: "
                . "'Mohon maaf, belum ada jawaban resmi untuk pertanyaan Anda di sistem kami.' "
                . "Jangan mengarang jawaban di luar data, jangan menggunakan pengetahuan luar Anda. Patuhi aturan ini dengan ketat.\n\n"
                . "DATA FAQ RESMI:\n" . $contextText;
