...
use App\Models\IcellServices\ApiEmpBareskrim\V2\Doc\P21Document;
    ...
    public function index(Request $request){
        $docService = $this->docService;
         ...
         try {
            ...
            DB::rollback();
            Log::error('IcellServices\ApiEmpBareskrim\V2\Doc\P21DocumentController::index', ['error' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
