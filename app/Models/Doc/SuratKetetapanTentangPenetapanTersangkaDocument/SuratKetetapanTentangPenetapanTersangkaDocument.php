...
class SuratKetetapanTentangPenetapanTersangkaDocument extends Model
{
    ...
    protected $table="doc.surat_ketetapan_tentang_penetapan_tersangka_documents";
    ...
    public static function boot()
    {
        ...
        self::creating(function ($model) {
            ...
            $model->status_id = '2';
            $model->document_category_id = '0215';
        });
    ...
    public function scopeWithRelated($query){
        return $query->with([
            ...
            'suratKetetapanTentangPenetapanTersangkaDocumentAttachment',
            'suspect',
            'createdByUser',
            'updatedByUser',
            'deletedByUser',
    ...
    {
        return $this->belongsTo('App\Models\Lib\SuspectSource', 'suspect_source_id');
    }
    ...
    public function suratKetetapanTentangPenetapanTersangkaDocumentOfficers(){
        return $this->hasMany('App\Models\Doc\SuratKetetapanTentangPenetapanTersangkaDocument\SuratKetetapanTentangPenetapanTersangkaDocumentOfficer', 'surat_ketetapan_tentang_penetapan_tersangka_document_id', 'id');
    }

    public function suratKetetapanTentangPenetapanTersangkaDocumentAttachment(){
        return $this->hasOne('App\Models\Doc\SuratKetetapanTentangPenetapanTersangkaDocument\SuratKetetapanTentangPenetapanTersangkaDocumentAttachment', 'surat_ketetapan_tentang_penetapan_tersangka_document_id', 'id');
    }

    public function suspect(){
        return $this->belongsToMany('App\Models\Suspect', 'pivot.surat_ketetapan_tentang_penetapan_tersangka_document_suspect', 'surat_ketetapan_tentang_penetapan_tersangka_document_id', 'suspect_id')
                ->withRelated();
    }
