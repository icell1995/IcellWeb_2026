...
class PermintaanPerpanjanganPenahananDocument extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'doc.permintaan_perpanjangan_penahanan_documents';
    ...
    public static function boot()
    {
        ...
        self::creating(function ($model) {
            ...
            $model->document_category_id = $model->document_category_id ?? '0603';
        });
    ...
    {
        return $this->belongsTo('App\Models\Suspect', 'suspect_id', 'id')->withRelated();
    }

    public function attachment()
    {
        return $this->hasOne(
            'App\Models\Doc\PermintaanPerpanjanganPenahananDocument\PermintaanPerpanjanganPenahananDocumentAttachment',
    ...
    {
        return $this->hasMany(
            PermintaanPerpanjanganPenahananDocumentOfficer::class,
            'permintaan_perpanjangan_penahanan_document_id',
            'id'
        );
    }
    ...
    public function signatory()
    {
        return $this->hasOne(
            ...
            'permintaan_perpanjangan_penahanan_document_id',
            'id'
        )->where('class', PermintaanPerpanjanganPenahananDocumentOfficer::getEnumOption('class', 'SIGNATORY'))
            ->orderBy('sort');
    }
