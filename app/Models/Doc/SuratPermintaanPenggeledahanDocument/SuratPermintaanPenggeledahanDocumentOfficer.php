...
class SuratPermintaanPenggeledahanDocumentOfficer extends Model
{
    use HasFactory;

    protected $table='doc.surat_permintaan_penggeledahan_document_officers';
    ...
    {
        return $query->with([
            'suratPermintaanPenggeledahanDocument', 
            'police',
            'position',
            'rank',
        ]);
    ...
    public function suratPermintaanPenggeledahanDocument()
    {
        return $this->belongsTo('App\Models\Doc\SuratPermintaanPenggeledahanDocument\SuratPermintaanPenggeledahanDocument', 'surat_permintaan_penggeledahan_document_id', 'id');
    }
