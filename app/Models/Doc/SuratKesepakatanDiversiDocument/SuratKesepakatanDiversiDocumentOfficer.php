...
class SuratKesepakatanDiversiDocumentOfficer extends Model
{
    use HasFactory;

    protected $table = 'doc.surat_kesepakatan_diversi_document_officers';
    ...
    {
        return $query->with([
            'suratKesepakatanDiversiDocument',
            'police',
            'position',
            'rank',
        ]);
