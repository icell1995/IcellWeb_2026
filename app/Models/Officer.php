...
class Officer extends Model
{
    ...
    // public function scopeHasNotExcept($query)
    // {
    //     return $query->where('is_except', '!=', true);
    // }
    ...
    public function scopeWhereHasUser($query)
    {
        return $query->whereHas('user');
    }

    public function scopeHasDataComplete($query)
    {
        return $query->whereHas('position');
    }

    public function scopeHasDataSpecific($query)
    {
        return $query->whereHas('gender');
    }
    ...
    public function rank(){
        return $this->belongsTo('App\Models\Lib\Rank', 'rank_id', 'id')->withRelated();
    }
    ...
    {
        return $this->hasMany(OfficerCertificateHistory::class, 'officer_id', 'id')->withRelated();
    }
    ...
    public function officerPoliceHistories()
    {
        return $this->hasMany(OfficerPoliceHistory::class, 'officer_id', 'id')->with(['police', 'position', 'rank']);
    }
