...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::beginTransaction();
        try {
            Schema::create('doc.surat_memperoleh_persetujuan_penggeledahan_document_officers', function (Blueprint $table) {
                ...
                $table->foreign('surat_memperoleh_persetujuan_penggeledahan_document_id', 'fk_surat_memperoleh_persetujuan_penggeledahan_officers_doc_id')
                    ->references('id')->on('doc.surat_memperoleh_persetujuan_penggeledahan_documents')
                    ->onDelete('cascade')->onUpdate('cascade');

                $table->foreign('police_id', 'fk_surat_memperoleh_persetujuan_penggeledahan_officers_police_id')
    ...
    public function down(): void
    {
        DB::beginTransaction();
        try {
            Schema::dropIfExists('doc.surat_memperoleh_persetujuan_penggeledahan_document_officers');
            DB::commit();
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
