...
class CreateDocSuratPerintahPenyidikanDocumentOfficersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('doc.surat_perintah_penyidikan_document_officers', function (Blueprint $table) {
            ...
            $table->foreign('surat_perintah_penyidikan_document_id', 'fk_spsidik_doc_officers_sp_penyidikan_document_id')->references('id')->on('doc.surat_perintah_penyidikan_documents')->onDelete('cascade')->onUpdate('cascade');
        });
    }
    ...
    public function down()
    {
        ...
        Schema::table('doc.surat_perintah_penyidikan_document_officers', function (Blueprint $table) {
            $table->dropForeign('fk_spsidik_doc_officers_sp_penyidikan_document_id');
        });

        Schema::dropIfExists('doc.surat_perintah_penyidikan_document_officers');
    }
}
