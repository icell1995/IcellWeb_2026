...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::beginTransaction();
        try {
            Schema::create('doc.surat_memperoleh_persetujuan_penggeledahan_documents', function (Blueprint $table) {
                ...
                $table->uuid('no_permintaan_penggeledahan_document_id')->nullable();
                ...
                $table->string('no_surat_perintah_penggeledahan')->nullable();
                $table->date('tgl_surat_perintah_penggeledahan')->nullable();
                ...
                $table->foreign('no_permintaan_penggeledahan_document_id', 'fk_penggeledahan_pus_docs_permintaan_penggeledahan_id')
    ...
    public function down(): void
    {
        DB::beginTransaction();
        try {
            Schema::dropIfExists('doc.surat_memperoleh_persetujuan_penggeledahan_documents');
            DB::commit();
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
