...
return new class extends Migration
{
    ...
    public function up(): void
    {
         DB::beginTransaction();
        try {
            Schema::create('doc.surat_permintaan_penggeledahan_document_officers', function (Blueprint $table) {
              $table->bigIncrements('id');
                ...
                $table->foreign('surat_permintaan_penggeledahan_document_id', 'fk_surat_permintaan_penggeledahan_officers_doc_id')
                    ->references('id')->on('doc.surat_permintaan_penggeledahan_documents')
                    ->onDelete('cascade')->onUpdate('cascade');

                $table->foreign('police_id', 'fk_surat_permintaan_penggeledahan_officers_police_id')
    ...
    public function down(): void
    {
        DB::beginTransaction();
        try {
            Schema::dropIfExists('doc.surat_permintaan_penggeledahan_document_officers');
