...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('public.stg_dors_victims', function (Blueprint $table) {
            ...
            $table->foreign('dors_accident_id', 'fk_stg_dors_victims_dors_accident_id')->references('id')->on('public.stg_dors_accidents')->onUpdate('CASCADE')->onDelete('SET NULL');
        });
    }
    ...
    public function down(): void
    {
        ...
        //     $table->dropForeign('fk_stg_dors_victims_dors_accident_id');
        // });
