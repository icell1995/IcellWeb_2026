...
class CreateDocSuratPerintahTugasDocumentOfficersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('doc.surat_perintah_tugas_document_officers', function (Blueprint $table) {
            ...
            $table->foreign('surat_perintah_tugas_document_id', 'fk_sptugas_doc_officers_sp_tugas_document_id')->references('id')->on('doc.surat_perintah_tugas_documents')->onDelete('cascade')->onUpdate('cascade');
        });
    }
    ...
    public function down()
    {
        ...
        Schema::table('doc.surat_perintah_tugas_document_officers', function (Blueprint $table) {
            $table->dropForeign('fk_sptugas_doc_officers_sp_tugas_document_id');
        });
