...
class ModifyDocSuratPerintahPenyelidikanDocumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        try{
            Schema::table('doc.surat_perintah_penyelidikan_documents', function (Blueprint $table) {
                ...
                $table->foreign('accident_id', 'investigation_warrants_accident_id_foreign')->references('id')->on('public.accidents')->onDelete('set null')->onUpdate('cascade');
            });
