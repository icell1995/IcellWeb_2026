...
class CreateInvestigationOrderLettersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('investigation_order_letters', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('investigation_order_letters');
    }
}
