...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('public.stg_dors_evidences', function (Blueprint $table) {
            ...
            $table->foreign('dors_accident_id', 'fk_stg_dors_evidences_dors_accident_id')->references('id')->on('public.stg_dors_accidents')->onUpdate('CASCADE')->onDelete('SET NULL');
        });
    }
    ...
    {
        // Schema::table('public.stg_dors_evidences', function (Blueprint $table) {
        //     $table->dropForeign('fk_stg_dors_evidences_dors_accident_id');
        // });
